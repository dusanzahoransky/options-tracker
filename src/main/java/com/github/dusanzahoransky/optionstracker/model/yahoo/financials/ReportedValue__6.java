...
public class ReportedValue__6 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__6.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__6) == false) {
            return false;
        }
        ReportedValue__6 rhs = ((ReportedValue__6) other);
