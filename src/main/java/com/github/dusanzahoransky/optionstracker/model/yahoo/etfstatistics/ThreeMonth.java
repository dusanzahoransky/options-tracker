...
public class ThreeMonth {
    ...
    public String toString() {
        ...
        sb.append(ThreeMonth.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThreeMonth) == false) {
            return false;
        }
        ThreeMonth rhs = ((ThreeMonth) other);
