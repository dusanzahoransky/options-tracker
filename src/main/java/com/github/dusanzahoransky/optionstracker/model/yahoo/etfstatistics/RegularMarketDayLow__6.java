...
public class RegularMarketDayLow__6 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow__6) == false) {
            return false;
        }
        RegularMarketDayLow__6 rhs = ((RegularMarketDayLow__6) other);
