...
public class RegularMarketDayHigh__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh__4) == false) {
            return false;
        }
        RegularMarketDayHigh__4 rhs = ((RegularMarketDayHigh__4) other);
