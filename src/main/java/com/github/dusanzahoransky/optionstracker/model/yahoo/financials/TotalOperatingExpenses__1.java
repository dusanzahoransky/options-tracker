...
public class TotalOperatingExpenses__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalOperatingExpenses__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalOperatingExpenses__1) == false) {
            return false;
        }
        TotalOperatingExpenses__1 rhs = ((TotalOperatingExpenses__1) other);
