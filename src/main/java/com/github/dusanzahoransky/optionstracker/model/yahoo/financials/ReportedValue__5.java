...
public class ReportedValue__5 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__5.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__5) == false) {
            return false;
        }
        ReportedValue__5 rhs = ((ReportedValue__5) other);
