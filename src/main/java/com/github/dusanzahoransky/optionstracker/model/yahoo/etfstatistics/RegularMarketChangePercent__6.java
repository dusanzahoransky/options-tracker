...
public class RegularMarketChangePercent__6 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChangePercent__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChangePercent__6) == false) {
            return false;
        }
        RegularMarketChangePercent__6 rhs = ((RegularMarketChangePercent__6) other);
