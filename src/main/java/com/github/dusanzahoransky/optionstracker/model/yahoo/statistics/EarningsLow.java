...
public class EarningsLow {
    ...
    public String toString() {
        ...
        sb.append(EarningsLow.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarningsLow) == false) {
            return false;
        }
        EarningsLow rhs = ((EarningsLow) other);
