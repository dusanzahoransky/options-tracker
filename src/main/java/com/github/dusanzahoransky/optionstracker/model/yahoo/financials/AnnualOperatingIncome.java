...
public class AnnualOperatingIncome {
    ...
    private ReportedValue__31 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__31 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__31 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualOperatingIncome.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualOperatingIncome) == false) {
            return false;
        }
        AnnualOperatingIncome rhs = ((AnnualOperatingIncome) other);
