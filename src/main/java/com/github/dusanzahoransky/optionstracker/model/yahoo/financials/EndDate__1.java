...
public class EndDate__1 {
    ...
    public String toString() {
        ...
        sb.append(EndDate__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EndDate__1) == false) {
            return false;
        }
        EndDate__1 rhs = ((EndDate__1) other);
