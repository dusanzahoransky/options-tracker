...
public class DeferredLongTermAssetCharges__1 {
    ...
    public String toString() {
        ...
        sb.append(DeferredLongTermAssetCharges__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeferredLongTermAssetCharges__1) == false) {
            return false;
        }
        DeferredLongTermAssetCharges__1 rhs = ((DeferredLongTermAssetCharges__1) other);
