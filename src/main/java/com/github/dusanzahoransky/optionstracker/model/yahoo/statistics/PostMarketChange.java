...
public class PostMarketChange {
    ...
    public String toString() {
        ...
        sb.append(PostMarketChange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PostMarketChange) == false) {
            return false;
        }
        PostMarketChange rhs = ((PostMarketChange) other);
