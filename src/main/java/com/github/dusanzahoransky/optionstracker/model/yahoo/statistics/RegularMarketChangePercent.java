...
public class RegularMarketChangePercent {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChangePercent.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChangePercent) == false) {
            return false;
        }
        RegularMarketChangePercent rhs = ((RegularMarketChangePercent) other);
