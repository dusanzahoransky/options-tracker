...
public class TrailingOperatingIncome {
    ...
    private ReportedValue__23 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__23 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__23 reportedValue) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingOperatingIncome) == false) {
            return false;
        }
