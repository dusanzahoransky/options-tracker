...
public class EarningsHistory {
    ...
    public String toString() {
        ...
        sb.append(EarningsHistory.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("history");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarningsHistory) == false) {
            return false;
        }
        EarningsHistory rhs = ((EarningsHistory) other);
