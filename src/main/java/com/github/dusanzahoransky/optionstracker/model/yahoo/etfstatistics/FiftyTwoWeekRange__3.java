...
public class FiftyTwoWeekRange__3 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekRange__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekRange__3) == false) {
            return false;
        }
        FiftyTwoWeekRange__3 rhs = ((FiftyTwoWeekRange__3) other);
