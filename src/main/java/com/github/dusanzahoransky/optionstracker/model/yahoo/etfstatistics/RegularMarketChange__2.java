...
public class RegularMarketChange__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChange__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChange__2) == false) {
            return false;
        }
        RegularMarketChange__2 rhs = ((RegularMarketChange__2) other);
