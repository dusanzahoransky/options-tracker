...
public class SectorTrend {
    ...
    public String toString() {
        ...
        sb.append(SectorTrend.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("maxAge");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectorTrend) == false) {
            return false;
        }
        SectorTrend rhs = ((SectorTrend) other);
