...
public class AnnualDilutedAverageShare {
    ...
    private ReportedValue__2 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__2 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__2 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualDilutedAverageShare.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualDilutedAverageShare) == false) {
            return false;
        }
        AnnualDilutedAverageShare rhs = ((AnnualDilutedAverageShare) other);
