...
public class RegularMarketTime__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketTime__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketTime__1) == false) {
            return false;
        }
        RegularMarketTime__1 rhs = ((RegularMarketTime__1) other);
