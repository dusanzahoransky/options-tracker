...
public class TotalCurrentAssets {
    ...
    public String toString() {
        ...
        sb.append(TotalCurrentAssets.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCurrentAssets) == false) {
            return false;
        }
        TotalCurrentAssets rhs = ((TotalCurrentAssets) other);
