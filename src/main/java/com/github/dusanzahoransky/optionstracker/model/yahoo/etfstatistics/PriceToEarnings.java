...
public class PriceToEarnings {
    ...
    public String toString() {
        ...
        sb.append(PriceToEarnings.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceToEarnings) == false) {
            return false;
        }
        PriceToEarnings rhs = ((PriceToEarnings) other);
