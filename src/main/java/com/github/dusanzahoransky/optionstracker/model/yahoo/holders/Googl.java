...
public class Googl {
    ...
    private RegularMarketOpen__2 regularMarketOpen;
    ...
    private RegularMarketDayHigh__2 regularMarketDayHigh;
    ...
    private RegularMarketChange__1 regularMarketChange;
    @JsonProperty("regularMarketPreviousClose")
    private RegularMarketPreviousClose__2 regularMarketPreviousClose;
    ...
    private RegularMarketDayLow__2 regularMarketDayLow;
    @JsonProperty("priceHint")
    private Long priceHint;
    @JsonProperty("currency")
    private String currency;
    @JsonProperty("regularMarketPrice")
    private RegularMarketPrice__1 regularMarketPrice;
    @JsonProperty("regularMarketVolume")
    private RegularMarketVolume__2 regularMarketVolume;
    ...
    private MarketCap__2 marketCap;
    ...
    private FiftyTwoWeekHigh__1 fiftyTwoWeekHigh;
    ...
    private FiftyTwoWeekLow__1 fiftyTwoWeekLow;
    @JsonProperty("regularMarketChangePercent")
    private RegularMarketChangePercent__1 regularMarketChangePercent;
    ...
    @JsonProperty("regularMarketOpen")
    public RegularMarketOpen__2 getRegularMarketOpen() {
        return regularMarketOpen;
    }

    @JsonProperty("regularMarketOpen")
    public void setRegularMarketOpen(RegularMarketOpen__2 regularMarketOpen) {
    ...
    @JsonProperty("regularMarketDayHigh")
    public RegularMarketDayHigh__2 getRegularMarketDayHigh() {
        return regularMarketDayHigh;
    }

    @JsonProperty("regularMarketDayHigh")
    public void setRegularMarketDayHigh(RegularMarketDayHigh__2 regularMarketDayHigh) {
    ...
    @JsonProperty("regularMarketChange")
    public RegularMarketChange__1 getRegularMarketChange() {
        return regularMarketChange;
    }

    @JsonProperty("regularMarketChange")
    public void setRegularMarketChange(RegularMarketChange__1 regularMarketChange) {
        this.regularMarketChange = regularMarketChange;
    }

    @JsonProperty("regularMarketPreviousClose")
    public RegularMarketPreviousClose__2 getRegularMarketPreviousClose() {
        return regularMarketPreviousClose;
    }

    @JsonProperty("regularMarketPreviousClose")
    public void setRegularMarketPreviousClose(RegularMarketPreviousClose__2 regularMarketPreviousClose) {
    ...
    @JsonProperty("regularMarketDayLow")
    public RegularMarketDayLow__2 getRegularMarketDayLow() {
        return regularMarketDayLow;
    }

    @JsonProperty("regularMarketDayLow")
    public void setRegularMarketDayLow(RegularMarketDayLow__2 regularMarketDayLow) {
    ...
    @JsonProperty("regularMarketPrice")
    public RegularMarketPrice__1 getRegularMarketPrice() {
        return regularMarketPrice;
    }

    @JsonProperty("regularMarketPrice")
    public void setRegularMarketPrice(RegularMarketPrice__1 regularMarketPrice) {
        this.regularMarketPrice = regularMarketPrice;
    }

    @JsonProperty("regularMarketVolume")
    public RegularMarketVolume__2 getRegularMarketVolume() {
        return regularMarketVolume;
    }

    @JsonProperty("regularMarketVolume")
    public void setRegularMarketVolume(RegularMarketVolume__2 regularMarketVolume) {
    ...
    @JsonProperty("marketCap")
    public MarketCap__2 getMarketCap() {
        return marketCap;
    }

    @JsonProperty("marketCap")
    public void setMarketCap(MarketCap__2 marketCap) {
    ...
    @JsonProperty("fiftyTwoWeekHigh")
    public FiftyTwoWeekHigh__1 getFiftyTwoWeekHigh() {
        return fiftyTwoWeekHigh;
    }

    @JsonProperty("fiftyTwoWeekHigh")
    public void setFiftyTwoWeekHigh(FiftyTwoWeekHigh__1 fiftyTwoWeekHigh) {
    ...
    @JsonProperty("fiftyTwoWeekLow")
    public FiftyTwoWeekLow__1 getFiftyTwoWeekLow() {
        return fiftyTwoWeekLow;
    }

    @JsonProperty("fiftyTwoWeekLow")
    public void setFiftyTwoWeekLow(FiftyTwoWeekLow__1 fiftyTwoWeekLow) {
        this.fiftyTwoWeekLow = fiftyTwoWeekLow;
    }

    @JsonProperty("regularMarketChangePercent")
    public RegularMarketChangePercent__1 getRegularMarketChangePercent() {
        return regularMarketChangePercent;
    }

    @JsonProperty("regularMarketChangePercent")
    public void setRegularMarketChangePercent(RegularMarketChangePercent__1 regularMarketChangePercent) {
    ...
    public String toString() {
        ...
        sb.append(Googl.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
