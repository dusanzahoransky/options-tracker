...
public class ReportedValue__16 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__16.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__16) == false) {
            return false;
        }
        ReportedValue__16 rhs = ((ReportedValue__16) other);
