...
public class CapitalExpenditures__1 {
    ...
    public String toString() {
        ...
        sb.append(CapitalExpenditures__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CapitalExpenditures__1) == false) {
            return false;
        }
        CapitalExpenditures__1 rhs = ((CapitalExpenditures__1) other);
