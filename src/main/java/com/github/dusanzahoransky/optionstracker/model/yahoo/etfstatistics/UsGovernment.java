...
public class UsGovernment {
    ...
    public String toString() {
        ...
        sb.append(UsGovernment.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UsGovernment) == false) {
            return false;
        }
        UsGovernment rhs = ((UsGovernment) other);
