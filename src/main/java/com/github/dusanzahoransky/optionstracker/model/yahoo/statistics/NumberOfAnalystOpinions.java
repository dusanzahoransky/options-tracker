...
public class NumberOfAnalystOpinions {
    ...
    public String toString() {
        ...
        sb.append(NumberOfAnalystOpinions.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NumberOfAnalystOpinions) == false) {
            return false;
        }
        NumberOfAnalystOpinions rhs = ((NumberOfAnalystOpinions) other);
