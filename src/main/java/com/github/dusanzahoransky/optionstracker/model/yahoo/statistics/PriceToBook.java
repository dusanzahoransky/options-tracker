...
public class PriceToBook {
    ...
    public String toString() {
        ...
        sb.append(PriceToBook.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceToBook) == false) {
            return false;
        }
        PriceToBook rhs = ((PriceToBook) other);
