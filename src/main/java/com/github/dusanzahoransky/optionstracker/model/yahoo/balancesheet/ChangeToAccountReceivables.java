...
public class ChangeToAccountReceivables {
    ...
    public String toString() {
        ...
        sb.append(ChangeToAccountReceivables.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeToAccountReceivables) == false) {
            return false;
        }
        ChangeToAccountReceivables rhs = ((ChangeToAccountReceivables) other);
