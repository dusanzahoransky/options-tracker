...
public class TrailingResearchAndDevelopment {
    ...
    private ReportedValue__27 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__27 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__27 reportedValue) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingResearchAndDevelopment) == false) {
            return false;
        }
        TrailingResearchAndDevelopment rhs = ((TrailingResearchAndDevelopment) other);
