...
public class OneYearTotalReturn {
    ...
    public String toString() {
        ...
        sb.append(OneYearTotalReturn.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OneYearTotalReturn) == false) {
            return false;
        }
        OneYearTotalReturn rhs = ((OneYearTotalReturn) other);
