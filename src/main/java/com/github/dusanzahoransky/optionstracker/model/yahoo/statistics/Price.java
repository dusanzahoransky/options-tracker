...
public class Price {
    ...
    public String toString() {
        ...
        sb.append(Price.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
