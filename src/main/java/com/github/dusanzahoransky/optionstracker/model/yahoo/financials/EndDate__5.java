...
public class EndDate__5 {
    ...
    public String toString() {
        ...
        sb.append(EndDate__5.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EndDate__5) == false) {
            return false;
        }
        EndDate__5 rhs = ((EndDate__5) other);
