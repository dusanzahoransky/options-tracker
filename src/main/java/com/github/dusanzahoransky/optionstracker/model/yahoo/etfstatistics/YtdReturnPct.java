...
public class YtdReturnPct {
    ...
    public String toString() {
        ...
        sb.append(YtdReturnPct.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof YtdReturnPct) == false) {
            return false;
        }
        YtdReturnPct rhs = ((YtdReturnPct) other);
