...
public class PegRatio {
    ...
    public String toString() {
        ...
        sb.append(PegRatio.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PegRatio) == false) {
            return false;
        }
        PegRatio rhs = ((PegRatio) other);
