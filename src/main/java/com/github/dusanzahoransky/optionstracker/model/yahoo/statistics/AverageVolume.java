...
public class AverageVolume {
    ...
    public String toString() {
        ...
        sb.append(AverageVolume.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AverageVolume) == false) {
            return false;
        }
        AverageVolume rhs = ((AverageVolume) other);
