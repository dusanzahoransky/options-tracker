...
public class TwoHundredDayAverage {
    ...
    public String toString() {
        ...
        sb.append(TwoHundredDayAverage.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TwoHundredDayAverage) == false) {
            return false;
        }
        TwoHundredDayAverage rhs = ((TwoHundredDayAverage) other);
