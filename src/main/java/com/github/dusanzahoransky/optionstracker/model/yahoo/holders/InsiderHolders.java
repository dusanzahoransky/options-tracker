...
public class InsiderHolders {
    ...
    public String toString() {
        ...
        sb.append(InsiderHolders.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("holders");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InsiderHolders) == false) {
            return false;
        }
        InsiderHolders rhs = ((InsiderHolders) other);
