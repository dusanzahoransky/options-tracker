...
public class FiftyTwoWeekLowChangePercent__4 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChangePercent__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChangePercent__4) == false) {
            return false;
        }
        FiftyTwoWeekLowChangePercent__4 rhs = ((FiftyTwoWeekLowChangePercent__4) other);
