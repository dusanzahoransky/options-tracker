...
public class RevenueHigh {
    ...
    public String toString() {
        ...
        sb.append(RevenueHigh.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RevenueHigh) == false) {
            return false;
        }
        RevenueHigh rhs = ((RevenueHigh) other);
