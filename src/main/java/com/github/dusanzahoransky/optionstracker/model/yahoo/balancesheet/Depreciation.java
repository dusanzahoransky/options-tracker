...
public class Depreciation {
    ...
    public String toString() {
        ...
        sb.append(Depreciation.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Depreciation) == false) {
            return false;
        }
        Depreciation rhs = ((Depreciation) other);
