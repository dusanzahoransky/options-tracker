...
public class RegularMarketOpen__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen__1) == false) {
            return false;
        }
        RegularMarketOpen__1 rhs = ((RegularMarketOpen__1) other);
