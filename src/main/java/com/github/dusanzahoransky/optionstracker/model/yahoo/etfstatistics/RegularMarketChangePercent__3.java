...
public class RegularMarketChangePercent__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChangePercent__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChangePercent__3) == false) {
            return false;
        }
        RegularMarketChangePercent__3 rhs = ((RegularMarketChangePercent__3) other);
