...
public class OperatingIncome__1 {
    ...
    public String toString() {
        ...
        sb.append(OperatingIncome__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OperatingIncome__1) == false) {
            return false;
        }
        OperatingIncome__1 rhs = ((OperatingIncome__1) other);
