...
public class TotalLiab__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalLiab__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalLiab__1) == false) {
            return false;
        }
        TotalLiab__1 rhs = ((TotalLiab__1) other);
