...
public class OtherCurrentAssets__1 {
    ...
    public String toString() {
        ...
        sb.append(OtherCurrentAssets__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCurrentAssets__1) == false) {
            return false;
        }
        OtherCurrentAssets__1 rhs = ((OtherCurrentAssets__1) other);
