...
public class PostMarketPrice {
    ...
    public String toString() {
        ...
        sb.append(PostMarketPrice.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PostMarketPrice) == false) {
            return false;
        }
        PostMarketPrice rhs = ((PostMarketPrice) other);
