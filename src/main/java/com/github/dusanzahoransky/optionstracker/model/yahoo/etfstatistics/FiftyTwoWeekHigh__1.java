...
public class FiftyTwoWeekHigh__1 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHigh__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHigh__1) == false) {
            return false;
        }
        FiftyTwoWeekHigh__1 rhs = ((FiftyTwoWeekHigh__1) other);
