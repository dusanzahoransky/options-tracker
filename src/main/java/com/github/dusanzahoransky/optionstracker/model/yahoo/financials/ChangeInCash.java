...
public class ChangeInCash {
    ...
    public String toString() {
        ...
        sb.append(ChangeInCash.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeInCash) == false) {
            return false;
        }
        ChangeInCash rhs = ((ChangeInCash) other);
