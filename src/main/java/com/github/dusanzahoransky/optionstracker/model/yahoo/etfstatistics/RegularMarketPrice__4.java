...
public class RegularMarketPrice__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPrice__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPrice__4) == false) {
            return false;
        }
        RegularMarketPrice__4 rhs = ((RegularMarketPrice__4) other);
