...
public class FiftyTwoWeekHighChangePercent__3 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChangePercent__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChangePercent__3) == false) {
            return false;
        }
        FiftyTwoWeekHighChangePercent__3 rhs = ((FiftyTwoWeekHighChangePercent__3) other);
