...
public class FreeCashflow {
    ...
    public String toString() {
        ...
        sb.append(FreeCashflow.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FreeCashflow) == false) {
            return false;
        }
        FreeCashflow rhs = ((FreeCashflow) other);
