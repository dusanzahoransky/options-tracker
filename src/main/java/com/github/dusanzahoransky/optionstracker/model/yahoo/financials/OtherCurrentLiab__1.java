...
public class OtherCurrentLiab__1 {
    ...
    public String toString() {
        ...
        sb.append(OtherCurrentLiab__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCurrentLiab__1) == false) {
            return false;
        }
        OtherCurrentLiab__1 rhs = ((OtherCurrentLiab__1) other);
