...
public class OtherCashflowsFromFinancingActivities__1 {
    ...
    public String toString() {
        ...
        sb.append(OtherCashflowsFromFinancingActivities__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCashflowsFromFinancingActivities__1) == false) {
            return false;
        }
        OtherCashflowsFromFinancingActivities__1 rhs = ((OtherCashflowsFromFinancingActivities__1) other);
