...
public class DateShortInterest {
    ...
    public String toString() {
        ...
        sb.append(DateShortInterest.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DateShortInterest) == false) {
            return false;
        }
        DateShortInterest rhs = ((DateShortInterest) other);
