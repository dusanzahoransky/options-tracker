...
public class ReturnOnAssets {
    ...
    public String toString() {
        ...
        sb.append(ReturnOnAssets.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReturnOnAssets) == false) {
            return false;
        }
        ReturnOnAssets rhs = ((ReturnOnAssets) other);
