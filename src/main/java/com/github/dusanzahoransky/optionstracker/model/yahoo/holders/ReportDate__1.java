...
public class ReportDate__1 {
    ...
    public String toString() {
        ...
        sb.append(ReportDate__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportDate__1) == false) {
            return false;
        }
        ReportDate__1 rhs = ((ReportDate__1) other);
