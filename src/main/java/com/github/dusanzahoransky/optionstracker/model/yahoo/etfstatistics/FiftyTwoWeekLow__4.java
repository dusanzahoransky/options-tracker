...
public class FiftyTwoWeekLow__4 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLow__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLow__4) == false) {
            return false;
        }
        FiftyTwoWeekLow__4 rhs = ((FiftyTwoWeekLow__4) other);
