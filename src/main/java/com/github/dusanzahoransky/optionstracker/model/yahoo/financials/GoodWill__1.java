...
public class GoodWill__1 {
    ...
    public String toString() {
        ...
        sb.append(GoodWill__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GoodWill__1) == false) {
            return false;
        }
        GoodWill__1 rhs = ((GoodWill__1) other);
