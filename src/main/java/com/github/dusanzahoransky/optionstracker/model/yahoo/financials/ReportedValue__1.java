...
public class ReportedValue__1 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__1) == false) {
            return false;
        }
        ReportedValue__1 rhs = ((ReportedValue__1) other);
