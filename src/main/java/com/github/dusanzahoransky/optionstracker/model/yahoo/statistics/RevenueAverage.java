...
public class RevenueAverage {
    ...
    public String toString() {
        ...
        sb.append(RevenueAverage.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RevenueAverage) == false) {
            return false;
        }
        RevenueAverage rhs = ((RevenueAverage) other);
