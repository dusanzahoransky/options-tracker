...
public class High__1 {
    ...
    public String toString() {
        ...
        sb.append(High__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof High__1) == false) {
            return false;
        }
        High__1 rhs = ((High__1) other);
