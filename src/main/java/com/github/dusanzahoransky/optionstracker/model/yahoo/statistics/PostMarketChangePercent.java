...
public class PostMarketChangePercent {
    ...
    public String toString() {
        ...
        sb.append(PostMarketChangePercent.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PostMarketChangePercent) == false) {
            return false;
        }
        PostMarketChangePercent rhs = ((PostMarketChangePercent) other);
