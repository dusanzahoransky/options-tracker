...
public class RegularMarketVolume__7 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketVolume__7 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketVolume__7) == false) {
            return false;
        }
        RegularMarketVolume__7 rhs = ((RegularMarketVolume__7) other);
