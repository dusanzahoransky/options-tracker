...
public class Earnings__1 {
    ...
    public String toString() {
        ...
        sb.append(Earnings__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Earnings__1) == false) {
            return false;
        }
        Earnings__1 rhs = ((Earnings__1) other);
