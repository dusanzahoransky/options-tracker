...
public class ReportedValue__12 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__12.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__12) == false) {
            return false;
        }
        ReportedValue__12 rhs = ((ReportedValue__12) other);
