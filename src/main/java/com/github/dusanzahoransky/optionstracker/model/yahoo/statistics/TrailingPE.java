...
public class TrailingPE {
    ...
    public String toString() {
        ...
        sb.append(TrailingPE.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingPE) == false) {
            return false;
        }
        TrailingPE rhs = ((TrailingPE) other);
