...
public class NetIncome__3 {
    ...
    public String toString() {
        ...
        sb.append(NetIncome__3.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncome__3) == false) {
            return false;
        }
        NetIncome__3 rhs = ((NetIncome__3) other);
