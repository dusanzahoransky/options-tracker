...
public class NumberOfAnalysts__1 {
    ...
    public String toString() {
        ...
        sb.append(NumberOfAnalysts__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NumberOfAnalysts__1) == false) {
            return false;
        }
        NumberOfAnalysts__1 rhs = ((NumberOfAnalysts__1) other);
