...
public class RegularMarketDayRange__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayRange__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayRange__5) == false) {
            return false;
        }
        RegularMarketDayRange__5 rhs = ((RegularMarketDayRange__5) other);
