...
public class GrossProfit__1 {
    ...
    public String toString() {
        ...
        sb.append(GrossProfit__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GrossProfit__1) == false) {
            return false;
        }
        GrossProfit__1 rhs = ((GrossProfit__1) other);
