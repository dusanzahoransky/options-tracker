...
public class FiftyTwoWeekLow__1 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLow__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLow__1) == false) {
            return false;
        }
        FiftyTwoWeekLow__1 rhs = ((FiftyTwoWeekLow__1) other);
