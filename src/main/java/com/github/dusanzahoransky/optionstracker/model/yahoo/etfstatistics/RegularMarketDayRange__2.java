...
public class RegularMarketDayRange__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayRange__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayRange__2) == false) {
            return false;
        }
        RegularMarketDayRange__2 rhs = ((RegularMarketDayRange__2) other);
