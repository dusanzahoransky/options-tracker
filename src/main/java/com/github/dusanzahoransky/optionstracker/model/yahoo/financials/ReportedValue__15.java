...
public class ReportedValue__15 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__15.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__15) == false) {
            return false;
        }
        ReportedValue__15 rhs = ((ReportedValue__15) other);
