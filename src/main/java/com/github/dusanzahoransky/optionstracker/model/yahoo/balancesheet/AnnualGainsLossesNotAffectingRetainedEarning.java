...
public class AnnualGainsLossesNotAffectingRetainedEarning {
    ...
    public String toString() {
        ...
        sb.append(AnnualGainsLossesNotAffectingRetainedEarning.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualGainsLossesNotAffectingRetainedEarning) == false) {
            return false;
        }
        AnnualGainsLossesNotAffectingRetainedEarning rhs = ((AnnualGainsLossesNotAffectingRetainedEarning) other);
