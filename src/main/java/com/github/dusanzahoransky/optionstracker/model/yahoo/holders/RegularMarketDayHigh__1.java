...
public class RegularMarketDayHigh__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh__1) == false) {
            return false;
        }
        RegularMarketDayHigh__1 rhs = ((RegularMarketDayHigh__1) other);
