...
public class ReportedValue__21 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__21.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__21) == false) {
            return false;
        }
        ReportedValue__21 rhs = ((ReportedValue__21) other);
