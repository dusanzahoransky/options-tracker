...
public class RegularMarketOpen__6 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen__6) == false) {
            return false;
        }
        RegularMarketOpen__6 rhs = ((RegularMarketOpen__6) other);
