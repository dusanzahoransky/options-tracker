...
public class TrailingTaxProvision {
    ...
    private ReportedValue__12 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__12 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__12 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingTaxProvision.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingTaxProvision) == false) {
            return false;
        }
        TrailingTaxProvision rhs = ((TrailingTaxProvision) other);
