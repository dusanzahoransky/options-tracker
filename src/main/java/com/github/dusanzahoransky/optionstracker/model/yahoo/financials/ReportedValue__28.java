...
public class ReportedValue__28 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__28.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__28) == false) {
            return false;
        }
        ReportedValue__28 rhs = ((ReportedValue__28) other);
