...
public class TotalLiab {
    ...
    public String toString() {
        ...
        sb.append(TotalLiab.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalLiab) == false) {
            return false;
        }
        TotalLiab rhs = ((TotalLiab) other);
