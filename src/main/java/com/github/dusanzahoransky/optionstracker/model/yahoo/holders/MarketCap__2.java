...
public class MarketCap__2 {
    ...
    public String toString() {
        ...
        sb.append(MarketCap__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MarketCap__2) == false) {
            return false;
        }
        MarketCap__2 rhs = ((MarketCap__2) other);
