...
public class PageViews {
    ...
    @JsonProperty("longTermTrend")
    public String getDoubleTermTrend() {
        return longTermTrend;
    }

    @JsonProperty("longTermTrend")
    public void setDoubleTermTrend(String longTermTrend) {
    ...
    public String toString() {
        ...
        sb.append(PageViews.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
