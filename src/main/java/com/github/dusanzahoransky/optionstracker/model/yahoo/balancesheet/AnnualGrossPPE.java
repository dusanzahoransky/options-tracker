...
public class AnnualGrossPPE {
    ...
    public String toString() {
        ...
        sb.append(AnnualGrossPPE.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualGrossPPE) == false) {
            return false;
        }
        AnnualGrossPPE rhs = ((AnnualGrossPPE) other);
