...
public class Yield__1 {
    ...
    public String toString() {
        ...
        sb.append(Yield__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yield__1) == false) {
            return false;
        }
        Yield__1 rhs = ((Yield__1) other);
