...
public class RegularMarketChangePercent__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChangePercent__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChangePercent__5) == false) {
            return false;
        }
        RegularMarketChangePercent__5 rhs = ((RegularMarketChangePercent__5) other);
