...
public class FiftyTwoWeekHighChange__4 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChange__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChange__4) == false) {
            return false;
        }
        FiftyTwoWeekHighChange__4 rhs = ((FiftyTwoWeekHighChange__4) other);
