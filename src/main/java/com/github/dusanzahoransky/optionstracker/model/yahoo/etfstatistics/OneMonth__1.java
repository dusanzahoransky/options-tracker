...
public class OneMonth__1 {
    ...
    public String toString() {
        ...
        sb.append(OneMonth__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OneMonth__1) == false) {
            return false;
        }
        OneMonth__1 rhs = ((OneMonth__1) other);
