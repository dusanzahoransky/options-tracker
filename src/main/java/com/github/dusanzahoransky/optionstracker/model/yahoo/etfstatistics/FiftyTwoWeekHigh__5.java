...
public class FiftyTwoWeekHigh__5 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHigh__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHigh__5) == false) {
            return false;
        }
        FiftyTwoWeekHigh__5 rhs = ((FiftyTwoWeekHigh__5) other);
