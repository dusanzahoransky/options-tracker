...
public class CostOfRevenue__1 {
    ...
    public String toString() {
        ...
        sb.append(CostOfRevenue__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CostOfRevenue__1) == false) {
            return false;
        }
        CostOfRevenue__1 rhs = ((CostOfRevenue__1) other);
