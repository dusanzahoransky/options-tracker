...
public class _90daysAgo {
    ...
    public String toString() {
        ...
        sb.append(_90daysAgo.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _90daysAgo) == false) {
            return false;
        }
        _90daysAgo rhs = ((_90daysAgo) other);
