...
public class InterestExpense__1 {
    ...
    public String toString() {
        ...
        sb.append(InterestExpense__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InterestExpense__1) == false) {
            return false;
        }
        InterestExpense__1 rhs = ((InterestExpense__1) other);
