...
public class YearAgoEps {
    ...
    public String toString() {
        ...
        sb.append(YearAgoEps.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof YearAgoEps) == false) {
            return false;
        }
        YearAgoEps rhs = ((YearAgoEps) other);
