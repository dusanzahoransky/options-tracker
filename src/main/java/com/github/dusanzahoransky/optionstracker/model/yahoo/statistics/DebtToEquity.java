...
public class DebtToEquity {
    ...
    public String toString() {
        ...
        sb.append(DebtToEquity.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DebtToEquity) == false) {
            return false;
        }
        DebtToEquity rhs = ((DebtToEquity) other);
