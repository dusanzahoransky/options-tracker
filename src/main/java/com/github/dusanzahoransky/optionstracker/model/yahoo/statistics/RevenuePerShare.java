...
public class RevenuePerShare {
    ...
    public String toString() {
        ...
        sb.append(RevenuePerShare.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RevenuePerShare) == false) {
            return false;
        }
        RevenuePerShare rhs = ((RevenuePerShare) other);
