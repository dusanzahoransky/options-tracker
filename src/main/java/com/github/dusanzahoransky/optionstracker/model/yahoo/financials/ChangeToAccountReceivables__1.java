...
public class ChangeToAccountReceivables__1 {
    ...
    public String toString() {
        ...
        sb.append(ChangeToAccountReceivables__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeToAccountReceivables__1) == false) {
            return false;
        }
        ChangeToAccountReceivables__1 rhs = ((ChangeToAccountReceivables__1) other);
