...
public class PayoutRatio {
    ...
    public String toString() {
        ...
        sb.append(PayoutRatio.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PayoutRatio) == false) {
            return false;
        }
        PayoutRatio rhs = ((PayoutRatio) other);
