...
public class AnnualLongTermDebt {
    ...
    public String toString() {
        ...
        sb.append(AnnualLongTermDebt.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualLongTermDebt) == false) {
            return false;
        }
        AnnualLongTermDebt rhs = ((AnnualLongTermDebt) other);
