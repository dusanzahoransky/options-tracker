...
public class AnnualGrossProfit {
    ...
    private ReportedValue__3 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__3 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__3 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualGrossProfit.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualGrossProfit) == false) {
            return false;
        }
        AnnualGrossProfit rhs = ((AnnualGrossProfit) other);
