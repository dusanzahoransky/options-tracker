...
public class NetIncomeToCommon {
    ...
    public String toString() {
        ...
        sb.append(NetIncomeToCommon.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncomeToCommon) == false) {
            return false;
        }
        NetIncomeToCommon rhs = ((NetIncomeToCommon) other);
