...
public class AnnualInterestExpense {
    ...
    private ReportedValue__16 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__16 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__16 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualInterestExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualInterestExpense) == false) {
            return false;
        }
        AnnualInterestExpense rhs = ((AnnualInterestExpense) other);
