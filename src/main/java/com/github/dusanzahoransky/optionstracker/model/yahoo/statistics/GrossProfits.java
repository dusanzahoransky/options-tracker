...
public class GrossProfits {
    ...
    public String toString() {
        ...
        sb.append(GrossProfits.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GrossProfits) == false) {
            return false;
        }
        GrossProfits rhs = ((GrossProfits) other);
