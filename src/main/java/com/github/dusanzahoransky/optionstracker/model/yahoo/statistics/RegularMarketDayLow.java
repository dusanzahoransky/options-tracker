...
public class RegularMarketDayLow {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow) == false) {
            return false;
        }
        RegularMarketDayLow rhs = ((RegularMarketDayLow) other);
