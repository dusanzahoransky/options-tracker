...
public class TotalCashFromOperatingActivities__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalCashFromOperatingActivities__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCashFromOperatingActivities__1) == false) {
            return false;
        }
        TotalCashFromOperatingActivities__1 rhs = ((TotalCashFromOperatingActivities__1) other);
