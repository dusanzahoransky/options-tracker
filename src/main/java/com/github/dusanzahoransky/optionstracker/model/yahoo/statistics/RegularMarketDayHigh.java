...
public class RegularMarketDayHigh {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh) == false) {
            return false;
        }
        RegularMarketDayHigh rhs = ((RegularMarketDayHigh) other);
