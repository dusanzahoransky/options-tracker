...
public class TotalRevenue {
    ...
    public String toString() {
        ...
        sb.append(TotalRevenue.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalRevenue) == false) {
            return false;
        }
        TotalRevenue rhs = ((TotalRevenue) other);
