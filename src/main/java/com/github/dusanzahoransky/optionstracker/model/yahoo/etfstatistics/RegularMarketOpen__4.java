...
public class RegularMarketOpen__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen__4) == false) {
            return false;
        }
        RegularMarketOpen__4 rhs = ((RegularMarketOpen__4) other);
