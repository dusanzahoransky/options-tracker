...
public class AnnualCurrentLiability {
    ...
    public String toString() {
        ...
        sb.append(AnnualCurrentLiability.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCurrentLiability) == false) {
            return false;
        }
        AnnualCurrentLiability rhs = ((AnnualCurrentLiability) other);
