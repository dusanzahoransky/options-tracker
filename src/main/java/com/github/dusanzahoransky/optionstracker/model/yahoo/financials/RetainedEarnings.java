...
public class RetainedEarnings {
    ...
    public String toString() {
        ...
        sb.append(RetainedEarnings.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetainedEarnings) == false) {
            return false;
        }
        RetainedEarnings rhs = ((RetainedEarnings) other);
