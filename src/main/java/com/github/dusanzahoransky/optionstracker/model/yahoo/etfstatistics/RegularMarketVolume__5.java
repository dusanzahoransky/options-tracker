...
public class RegularMarketVolume__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketVolume__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketVolume__5) == false) {
            return false;
        }
        RegularMarketVolume__5 rhs = ((RegularMarketVolume__5) other);
