...
public class ReportedValue__17 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__17.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__17) == false) {
            return false;
        }
        ReportedValue__17 rhs = ((ReportedValue__17) other);
