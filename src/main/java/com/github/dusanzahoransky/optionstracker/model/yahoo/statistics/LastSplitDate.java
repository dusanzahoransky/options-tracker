...
public class LastSplitDate {
    ...
    public String toString() {
        ...
        sb.append(LastSplitDate.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LastSplitDate) == false) {
            return false;
        }
        LastSplitDate rhs = ((LastSplitDate) other);
