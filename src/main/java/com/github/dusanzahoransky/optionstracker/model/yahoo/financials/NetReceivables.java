...
public class NetReceivables {
    ...
    public String toString() {
        ...
        sb.append(NetReceivables.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetReceivables) == false) {
            return false;
        }
        NetReceivables rhs = ((NetReceivables) other);
