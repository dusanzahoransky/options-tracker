...
public class RegularMarketPrice__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPrice__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPrice__1) == false) {
            return false;
        }
        RegularMarketPrice__1 rhs = ((RegularMarketPrice__1) other);
