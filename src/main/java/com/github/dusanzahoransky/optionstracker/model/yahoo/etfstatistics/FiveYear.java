...
public class FiveYear {
    ...
    public String toString() {
        ...
        sb.append(FiveYear.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiveYear) == false) {
            return false;
        }
        FiveYear rhs = ((FiveYear) other);
