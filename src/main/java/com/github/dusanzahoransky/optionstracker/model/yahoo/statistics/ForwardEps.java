...
public class ForwardEps {
    ...
    public String toString() {
        ...
        sb.append(ForwardEps.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ForwardEps) == false) {
            return false;
        }
        ForwardEps rhs = ((ForwardEps) other);
