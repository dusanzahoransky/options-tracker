...
public class ThreeYear__2 {
    ...
    public String toString() {
        ...
        sb.append(ThreeYear__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThreeYear__2) == false) {
            return false;
        }
        ThreeYear__2 rhs = ((ThreeYear__2) other);
