...
public class NetTangibleAssets {
    ...
    public String toString() {
        ...
        sb.append(NetTangibleAssets.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetTangibleAssets) == false) {
            return false;
        }
        NetTangibleAssets rhs = ((NetTangibleAssets) other);
