...
public class EnterpriseToRevenue {
    ...
    public String toString() {
        ...
        sb.append(EnterpriseToRevenue.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EnterpriseToRevenue) == false) {
            return false;
        }
        EnterpriseToRevenue rhs = ((EnterpriseToRevenue) other);
