...
public class SharesShort {
    ...
    public String toString() {
        ...
        sb.append(SharesShort.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SharesShort) == false) {
            return false;
        }
        SharesShort rhs = ((SharesShort) other);
