...
public class TenYear__2 {
    ...
    public String toString() {
        ...
        sb.append(TenYear__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TenYear__2) == false) {
            return false;
        }
        TenYear__2 rhs = ((TenYear__2) other);
