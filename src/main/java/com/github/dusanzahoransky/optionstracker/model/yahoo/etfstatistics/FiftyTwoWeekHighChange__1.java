...
public class FiftyTwoWeekHighChange__1 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChange__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChange__1) == false) {
            return false;
        }
        FiftyTwoWeekHighChange__1 rhs = ((FiftyTwoWeekHighChange__1) other);
