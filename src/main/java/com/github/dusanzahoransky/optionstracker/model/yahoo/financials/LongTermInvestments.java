...
public class LongTermInvestments {
    ...
    public String toString() {
        ...
        sb.append(LongTermInvestments.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LongTermInvestments) == false) {
            return false;
        }
        LongTermInvestments rhs = ((LongTermInvestments) other);
