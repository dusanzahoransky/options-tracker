...
public class TotalCashflowsFromInvestingActivities__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalCashflowsFromInvestingActivities__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCashflowsFromInvestingActivities__1) == false) {
            return false;
        }
        TotalCashflowsFromInvestingActivities__1 rhs = ((TotalCashflowsFromInvestingActivities__1) other);
