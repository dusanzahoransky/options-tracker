...
public class TotalOperatingExpenses {
    ...
    public String toString() {
        ...
        sb.append(TotalOperatingExpenses.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalOperatingExpenses) == false) {
            return false;
        }
        TotalOperatingExpenses rhs = ((TotalOperatingExpenses) other);
