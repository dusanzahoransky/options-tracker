...
public class RegularMarketOpen__7 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen__7 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen__7) == false) {
            return false;
        }
        RegularMarketOpen__7 rhs = ((RegularMarketOpen__7) other);
