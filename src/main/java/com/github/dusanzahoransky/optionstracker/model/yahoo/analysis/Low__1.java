...
public class Low__1 {
    ...
    public String toString() {
        ...
        sb.append(Low__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Low__1) == false) {
            return false;
        }
        Low__1 rhs = ((Low__1) other);
