...
public class PriceToBook__1 {
    ...
    public String toString() {
        ...
        sb.append(PriceToBook__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceToBook__1) == false) {
            return false;
        }
        PriceToBook__1 rhs = ((PriceToBook__1) other);
