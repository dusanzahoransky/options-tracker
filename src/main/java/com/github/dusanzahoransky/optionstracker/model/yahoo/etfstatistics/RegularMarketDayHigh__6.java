...
public class RegularMarketDayHigh__6 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh__6) == false) {
            return false;
        }
        RegularMarketDayHigh__6 rhs = ((RegularMarketDayHigh__6) other);
