...
public class AnnualCurrentDeferredRevenue {
    ...
    public String toString() {
        ...
        sb.append(AnnualCurrentDeferredRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCurrentDeferredRevenue) == false) {
            return false;
        }
        AnnualCurrentDeferredRevenue rhs = ((AnnualCurrentDeferredRevenue) other);
