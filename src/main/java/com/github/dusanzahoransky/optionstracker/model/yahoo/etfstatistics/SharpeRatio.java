...
public class SharpeRatio {
    ...
    public String toString() {
        ...
        sb.append(SharpeRatio.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SharpeRatio) == false) {
            return false;
        }
        SharpeRatio rhs = ((SharpeRatio) other);
