...
public class Healthcare {
    ...
    public String toString() {
        ...
        sb.append(Healthcare.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Healthcare) == false) {
            return false;
        }
        Healthcare rhs = ((Healthcare) other);
