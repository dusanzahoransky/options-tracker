...
public class AccountsPayable {
    ...
    public String toString() {
        ...
        sb.append(AccountsPayable.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccountsPayable) == false) {
            return false;
        }
        AccountsPayable rhs = ((AccountsPayable) other);
