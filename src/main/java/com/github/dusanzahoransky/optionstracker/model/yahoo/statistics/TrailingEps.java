...
public class TrailingEps {
    ...
    public String toString() {
        ...
        sb.append(TrailingEps.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingEps) == false) {
            return false;
        }
        TrailingEps rhs = ((TrailingEps) other);
