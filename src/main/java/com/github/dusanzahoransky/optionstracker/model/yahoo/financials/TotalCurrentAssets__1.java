...
public class TotalCurrentAssets__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalCurrentAssets__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCurrentAssets__1) == false) {
            return false;
        }
        TotalCurrentAssets__1 rhs = ((TotalCurrentAssets__1) other);
