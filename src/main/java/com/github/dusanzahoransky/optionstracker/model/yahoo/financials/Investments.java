...
public class Investments {
    ...
    public String toString() {
        ...
        sb.append(Investments.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Investments) == false) {
            return false;
        }
        Investments rhs = ((Investments) other);
