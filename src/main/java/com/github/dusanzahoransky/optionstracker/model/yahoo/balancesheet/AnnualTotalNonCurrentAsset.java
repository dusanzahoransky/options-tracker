...
public class AnnualTotalNonCurrentAsset {
    ...
    public String toString() {
        ...
        sb.append(AnnualTotalNonCurrentAsset.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualTotalNonCurrentAsset) == false) {
            return false;
        }
        AnnualTotalNonCurrentAsset rhs = ((AnnualTotalNonCurrentAsset) other);
