...
public class RegularMarketPrice__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPrice__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPrice__2) == false) {
            return false;
        }
        RegularMarketPrice__2 rhs = ((RegularMarketPrice__2) other);
