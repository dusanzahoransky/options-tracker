...
public class DownLast30days {
    ...
    public String toString() {
        ...
        sb.append(DownLast30days.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DownLast30days) == false) {
            return false;
        }
        DownLast30days rhs = ((DownLast30days) other);
