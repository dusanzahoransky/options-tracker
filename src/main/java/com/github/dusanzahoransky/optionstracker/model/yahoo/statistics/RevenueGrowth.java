...
public class RevenueGrowth {
    ...
    public String toString() {
        ...
        sb.append(RevenueGrowth.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RevenueGrowth) == false) {
            return false;
        }
        RevenueGrowth rhs = ((RevenueGrowth) other);
