...
public class RegularMarketPreviousClose__6 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose__6) == false) {
            return false;
        }
        RegularMarketPreviousClose__6 rhs = ((RegularMarketPreviousClose__6) other);
