...
public class CurrentQuarterEstimate {
    ...
    public String toString() {
        ...
        sb.append(CurrentQuarterEstimate.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurrentQuarterEstimate) == false) {
            return false;
        }
        CurrentQuarterEstimate rhs = ((CurrentQuarterEstimate) other);
