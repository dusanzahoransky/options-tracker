...
public class TrailingNetIncomeContinuousOperation {
    ...
    private ReportedValue__30 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__30 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__30 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingNetIncomeContinuousOperation.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingNetIncomeContinuousOperation) == false) {
            return false;
        }
        TrailingNetIncomeContinuousOperation rhs = ((TrailingNetIncomeContinuousOperation) other);
