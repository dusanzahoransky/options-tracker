...
public class Earnings__2 {
    ...
    public String toString() {
        ...
        sb.append(Earnings__2.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Earnings__2) == false) {
            return false;
        }
        Earnings__2 rhs = ((Earnings__2) other);
