...
public class FinancialsChart {
    ...
    private List<Quarterly__1> quarterly = new ArrayList<Quarterly__1>();
    @JsonIgnore
    ...
    @JsonProperty("quarterly")
    public List<Quarterly__1> getQuarterly() {
        return quarterly;
    }

    @JsonProperty("quarterly")
    public void setQuarterly(List<Quarterly__1> quarterly) {
