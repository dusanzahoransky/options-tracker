...
public class ReportedValue__30 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__30.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__30) == false) {
            return false;
        }
        ReportedValue__30 rhs = ((ReportedValue__30) other);
