...
public class RegularMarketDayRange__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayRange__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayRange__3) == false) {
            return false;
        }
        RegularMarketDayRange__3 rhs = ((RegularMarketDayRange__3) other);
