...
public class FiftyTwoWeekRange__2 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekRange__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekRange__2) == false) {
            return false;
        }
        FiftyTwoWeekRange__2 rhs = ((FiftyTwoWeekRange__2) other);
