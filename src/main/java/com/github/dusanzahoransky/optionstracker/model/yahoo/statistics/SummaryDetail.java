...
public class SummaryDetail {
    ...
    public SummaryDetail setTrailingPE(TrailingPE trailingPE) {
    ...
    public String toString() {
        ...
        sb.append(SummaryDetail.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
