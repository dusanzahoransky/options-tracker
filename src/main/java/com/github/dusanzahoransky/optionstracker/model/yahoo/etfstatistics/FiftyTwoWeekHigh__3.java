...
public class FiftyTwoWeekHigh__3 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHigh__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHigh__3) == false) {
            return false;
        }
        FiftyTwoWeekHigh__3 rhs = ((FiftyTwoWeekHigh__3) other);
