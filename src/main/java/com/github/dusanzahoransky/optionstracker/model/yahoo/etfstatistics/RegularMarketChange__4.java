...
public class RegularMarketChange__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChange__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChange__4) == false) {
            return false;
        }
        RegularMarketChange__4 rhs = ((RegularMarketChange__4) other);
