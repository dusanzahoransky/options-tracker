...
public class ThreeMonth__1 {
    ...
    public String toString() {
        ...
        sb.append(ThreeMonth__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThreeMonth__1) == false) {
            return false;
        }
        ThreeMonth__1 rhs = ((ThreeMonth__1) other);
