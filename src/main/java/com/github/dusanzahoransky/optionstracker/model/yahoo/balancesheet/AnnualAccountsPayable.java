...
public class AnnualAccountsPayable {
    ...
    public String toString() {
        ...
        sb.append(AnnualAccountsPayable.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualAccountsPayable) == false) {
            return false;
        }
        AnnualAccountsPayable rhs = ((AnnualAccountsPayable) other);
