...
public class AnnualTotalNonCurrentLiabilitiesNetMinorityInterest {
    ...
    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualTotalNonCurrentLiabilitiesNetMinorityInterest.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualTotalNonCurrentLiabilitiesNetMinorityInterest) == false) {
            return false;
        }
        AnnualTotalNonCurrentLiabilitiesNetMinorityInterest rhs = ((AnnualTotalNonCurrentLiabilitiesNetMinorityInterest) other);
