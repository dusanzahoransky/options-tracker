...
public class FiftyTwoWeekLowChangePercent__3 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChangePercent__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChangePercent__3) == false) {
            return false;
        }
        FiftyTwoWeekLowChangePercent__3 rhs = ((FiftyTwoWeekLowChangePercent__3) other);
