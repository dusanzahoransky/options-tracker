...
public class ReportedValue__19 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__19.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__19) == false) {
            return false;
        }
        ReportedValue__19 rhs = ((ReportedValue__19) other);
