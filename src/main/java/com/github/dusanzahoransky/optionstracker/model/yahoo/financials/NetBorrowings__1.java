...
public class NetBorrowings__1 {
    ...
    public String toString() {
        ...
        sb.append(NetBorrowings__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetBorrowings__1) == false) {
            return false;
        }
        NetBorrowings__1 rhs = ((NetBorrowings__1) other);
