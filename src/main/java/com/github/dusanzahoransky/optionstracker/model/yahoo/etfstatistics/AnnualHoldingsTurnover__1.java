...
public class AnnualHoldingsTurnover__1 {
    ...
    public String toString() {
        ...
        sb.append(AnnualHoldingsTurnover__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualHoldingsTurnover__1) == false) {
            return false;
        }
        AnnualHoldingsTurnover__1 rhs = ((AnnualHoldingsTurnover__1) other);
