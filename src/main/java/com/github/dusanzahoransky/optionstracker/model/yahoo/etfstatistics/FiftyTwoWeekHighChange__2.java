...
public class FiftyTwoWeekHighChange__2 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChange__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChange__2) == false) {
            return false;
        }
        FiftyTwoWeekHighChange__2 rhs = ((FiftyTwoWeekHighChange__2) other);
