...
public class LastFiscalYearEnd {
    ...
    public String toString() {
        ...
        sb.append(LastFiscalYearEnd.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LastFiscalYearEnd) == false) {
            return false;
        }
        LastFiscalYearEnd rhs = ((LastFiscalYearEnd) other);
