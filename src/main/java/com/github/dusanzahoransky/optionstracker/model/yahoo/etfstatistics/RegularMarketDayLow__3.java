...
public class RegularMarketDayLow__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow__3) == false) {
            return false;
        }
        RegularMarketDayLow__3 rhs = ((RegularMarketDayLow__3) other);
