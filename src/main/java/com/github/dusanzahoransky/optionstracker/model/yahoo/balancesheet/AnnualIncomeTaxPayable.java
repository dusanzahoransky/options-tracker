...
public class AnnualIncomeTaxPayable {
    ...
    public String toString() {
        ...
        sb.append(AnnualIncomeTaxPayable.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualIncomeTaxPayable) == false) {
            return false;
        }
        AnnualIncomeTaxPayable rhs = ((AnnualIncomeTaxPayable) other);
