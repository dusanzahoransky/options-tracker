...
public class YearAgoRevenue {
    ...
    public String toString() {
        ...
        sb.append(YearAgoRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof YearAgoRevenue) == false) {
            return false;
        }
        YearAgoRevenue rhs = ((YearAgoRevenue) other);
