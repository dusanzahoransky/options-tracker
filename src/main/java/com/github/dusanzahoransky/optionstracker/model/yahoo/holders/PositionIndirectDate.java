...
public class PositionIndirectDate {
    ...
    public String toString() {
        ...
        sb.append(PositionIndirectDate.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionIndirectDate) == false) {
            return false;
        }
        PositionIndirectDate rhs = ((PositionIndirectDate) other);
