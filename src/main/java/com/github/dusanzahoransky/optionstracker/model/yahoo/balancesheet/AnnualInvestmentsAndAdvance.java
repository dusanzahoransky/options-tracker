...
public class AnnualInvestmentsAndAdvance {
    ...
    public String toString() {
        ...
        sb.append(AnnualInvestmentsAndAdvance.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualInvestmentsAndAdvance) == false) {
            return false;
        }
        AnnualInvestmentsAndAdvance rhs = ((AnnualInvestmentsAndAdvance) other);
