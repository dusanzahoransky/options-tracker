...
public class PropertyPlantEquipment__1 {
    ...
    public String toString() {
        ...
        sb.append(PropertyPlantEquipment__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PropertyPlantEquipment__1) == false) {
            return false;
        }
        PropertyPlantEquipment__1 rhs = ((PropertyPlantEquipment__1) other);
