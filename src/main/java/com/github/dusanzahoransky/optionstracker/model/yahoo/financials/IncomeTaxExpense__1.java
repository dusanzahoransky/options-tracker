...
public class IncomeTaxExpense__1 {
    ...
    public String toString() {
        ...
        sb.append(IncomeTaxExpense__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IncomeTaxExpense__1) == false) {
            return false;
        }
        IncomeTaxExpense__1 rhs = ((IncomeTaxExpense__1) other);
