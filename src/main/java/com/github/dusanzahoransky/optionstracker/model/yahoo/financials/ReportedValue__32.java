...
public class ReportedValue__32 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__32.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__32) == false) {
            return false;
        }
        ReportedValue__32 rhs = ((ReportedValue__32) other);
