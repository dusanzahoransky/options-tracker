...
public class RegularMarketVolume__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketVolume__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketVolume__4) == false) {
            return false;
        }
        RegularMarketVolume__4 rhs = ((RegularMarketVolume__4) other);
