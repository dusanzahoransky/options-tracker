...
public class FiftyTwoWeekHighChangePercent__5 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChangePercent__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChangePercent__5) == false) {
            return false;
        }
        FiftyTwoWeekHighChangePercent__5 rhs = ((FiftyTwoWeekHighChangePercent__5) other);
