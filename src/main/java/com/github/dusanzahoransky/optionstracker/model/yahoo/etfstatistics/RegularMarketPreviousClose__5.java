...
public class RegularMarketPreviousClose__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose__5) == false) {
            return false;
        }
        RegularMarketPreviousClose__5 rhs = ((RegularMarketPreviousClose__5) other);
