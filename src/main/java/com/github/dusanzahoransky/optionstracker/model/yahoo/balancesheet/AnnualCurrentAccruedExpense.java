...
public class AnnualCurrentAccruedExpense {
    ...
    public String toString() {
        ...
        sb.append(AnnualCurrentAccruedExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCurrentAccruedExpense) == false) {
            return false;
        }
        AnnualCurrentAccruedExpense rhs = ((AnnualCurrentAccruedExpense) other);
