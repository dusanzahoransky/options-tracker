...
public class OtherAssets__1 {
    ...
    public String toString() {
        ...
        sb.append(OtherAssets__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherAssets__1) == false) {
            return false;
        }
        OtherAssets__1 rhs = ((OtherAssets__1) other);
