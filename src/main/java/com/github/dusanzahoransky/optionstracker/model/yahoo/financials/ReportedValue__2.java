...
public class ReportedValue__2 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__2.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__2) == false) {
            return false;
        }
        ReportedValue__2 rhs = ((ReportedValue__2) other);
