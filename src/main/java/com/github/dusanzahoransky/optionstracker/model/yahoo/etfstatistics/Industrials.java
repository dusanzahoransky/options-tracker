...
public class Industrials {
    ...
    public String toString() {
        ...
        sb.append(Industrials.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Industrials) == false) {
            return false;
        }
        Industrials rhs = ((Industrials) other);
