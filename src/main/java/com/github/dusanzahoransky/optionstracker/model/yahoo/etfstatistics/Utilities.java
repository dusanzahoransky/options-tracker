...
public class Utilities {
    ...
    public String toString() {
        ...
        sb.append(Utilities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Utilities) == false) {
            return false;
        }
        Utilities rhs = ((Utilities) other);
