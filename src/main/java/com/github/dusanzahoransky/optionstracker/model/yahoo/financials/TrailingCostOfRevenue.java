...
public class TrailingCostOfRevenue {
    ...
    private ReportedValue__17 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__17 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__17 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingCostOfRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingCostOfRevenue) == false) {
            return false;
        }
        TrailingCostOfRevenue rhs = ((TrailingCostOfRevenue) other);
