...
public class _7daysAgo {
    ...
    public String toString() {
        ...
        sb.append(_7daysAgo.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _7daysAgo) == false) {
            return false;
        }
        _7daysAgo rhs = ((_7daysAgo) other);
