...
public class TotalCurrentLiabilities {
    ...
    public String toString() {
        ...
        sb.append(TotalCurrentLiabilities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCurrentLiabilities) == false) {
            return false;
        }
        TotalCurrentLiabilities rhs = ((TotalCurrentLiabilities) other);
