...
public class PropertyPlantEquipment {
    ...
    public String toString() {
        ...
        sb.append(PropertyPlantEquipment.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PropertyPlantEquipment) == false) {
            return false;
        }
        PropertyPlantEquipment rhs = ((PropertyPlantEquipment) other);
