...
public class TargetMeanPrice {
    ...
    public String toString() {
        ...
        sb.append(TargetMeanPrice.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TargetMeanPrice) == false) {
            return false;
        }
        TargetMeanPrice rhs = ((TargetMeanPrice) other);
