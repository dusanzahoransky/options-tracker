...
public class AnnualTaxProvision {
    ...
    private ReportedValue__11 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__11 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__11 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualTaxProvision.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualTaxProvision) == false) {
            return false;
        }
        AnnualTaxProvision rhs = ((AnnualTaxProvision) other);
