...
public class OneMonth__2 {
    ...
    public String toString() {
        ...
        sb.append(OneMonth__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OneMonth__2) == false) {
            return false;
        }
        OneMonth__2 rhs = ((OneMonth__2) other);
