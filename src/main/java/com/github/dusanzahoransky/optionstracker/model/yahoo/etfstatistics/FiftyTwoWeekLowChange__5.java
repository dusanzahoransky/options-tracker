...
public class FiftyTwoWeekLowChange__5 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChange__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChange__5) == false) {
            return false;
        }
        FiftyTwoWeekLowChange__5 rhs = ((FiftyTwoWeekLowChange__5) other);
