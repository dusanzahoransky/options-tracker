...
public class RegularMarketTime__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketTime__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketTime__4) == false) {
            return false;
        }
        RegularMarketTime__4 rhs = ((RegularMarketTime__4) other);
