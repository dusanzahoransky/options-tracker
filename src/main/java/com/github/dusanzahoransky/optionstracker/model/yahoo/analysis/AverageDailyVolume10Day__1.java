...
public class AverageDailyVolume10Day__1 {
    ...
    public String toString() {
        ...
        sb.append(AverageDailyVolume10Day__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AverageDailyVolume10Day__1) == false) {
            return false;
        }
        AverageDailyVolume10Day__1 rhs = ((AverageDailyVolume10Day__1) other);
