...
public class ReturnOnEquity {
    ...
    public String toString() {
        ...
        sb.append(ReturnOnEquity.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReturnOnEquity) == false) {
            return false;
        }
        ReturnOnEquity rhs = ((ReturnOnEquity) other);
