...
public class RegularMarketChange__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChange__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChange__1) == false) {
            return false;
        }
        RegularMarketChange__1 rhs = ((RegularMarketChange__1) other);
