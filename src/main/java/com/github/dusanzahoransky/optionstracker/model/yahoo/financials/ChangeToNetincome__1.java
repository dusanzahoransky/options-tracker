...
public class ChangeToNetincome__1 {
    ...
    public String toString() {
        ...
        sb.append(ChangeToNetincome__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeToNetincome__1) == false) {
            return false;
        }
        ChangeToNetincome__1 rhs = ((ChangeToNetincome__1) other);
