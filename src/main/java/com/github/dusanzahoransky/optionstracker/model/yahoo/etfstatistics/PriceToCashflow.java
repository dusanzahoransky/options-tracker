...
public class PriceToCashflow {
    ...
    public String toString() {
        ...
        sb.append(PriceToCashflow.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceToCashflow) == false) {
            return false;
        }
        PriceToCashflow rhs = ((PriceToCashflow) other);
