...
public class NetTangibleAssets__1 {
    ...
    public String toString() {
        ...
        sb.append(NetTangibleAssets__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetTangibleAssets__1) == false) {
            return false;
        }
        NetTangibleAssets__1 rhs = ((NetTangibleAssets__1) other);
