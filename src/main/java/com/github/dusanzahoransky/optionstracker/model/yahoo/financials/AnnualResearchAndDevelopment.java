...
public class AnnualResearchAndDevelopment {
    ...
    private ReportedValue__7 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__7 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__7 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualResearchAndDevelopment.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualResearchAndDevelopment) == false) {
            return false;
        }
        AnnualResearchAndDevelopment rhs = ((AnnualResearchAndDevelopment) other);
