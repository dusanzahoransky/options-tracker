...
public class FiftyTwoWeekLowChangePercent__2 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChangePercent__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChangePercent__2) == false) {
            return false;
        }
        FiftyTwoWeekLowChangePercent__2 rhs = ((FiftyTwoWeekLowChangePercent__2) other);
