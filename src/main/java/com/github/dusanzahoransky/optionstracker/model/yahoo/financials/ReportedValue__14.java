...
public class ReportedValue__14 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__14.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__14) == false) {
            return false;
        }
        ReportedValue__14 rhs = ((ReportedValue__14) other);
