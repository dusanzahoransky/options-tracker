...
public class TotalCurrentLiabilities__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalCurrentLiabilities__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCurrentLiabilities__1) == false) {
            return false;
        }
        TotalCurrentLiabilities__1 rhs = ((TotalCurrentLiabilities__1) other);
