...
public class TrailingSellingGeneralAndAdministration {
    ...
    public String toString() {
        ...
        sb.append(TrailingSellingGeneralAndAdministration.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingSellingGeneralAndAdministration) == false) {
            return false;
        }
        TrailingSellingGeneralAndAdministration rhs = ((TrailingSellingGeneralAndAdministration) other);
