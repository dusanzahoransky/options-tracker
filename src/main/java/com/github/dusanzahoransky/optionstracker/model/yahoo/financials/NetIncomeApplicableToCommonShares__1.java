...
public class NetIncomeApplicableToCommonShares__1 {
    ...
    public String toString() {
        ...
        sb.append(NetIncomeApplicableToCommonShares__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncomeApplicableToCommonShares__1) == false) {
            return false;
        }
        NetIncomeApplicableToCommonShares__1 rhs = ((NetIncomeApplicableToCommonShares__1) other);
