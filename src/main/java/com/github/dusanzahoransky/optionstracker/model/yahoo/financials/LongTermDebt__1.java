...
public class LongTermDebt__1 {
    ...
    public String toString() {
        ...
        sb.append(LongTermDebt__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LongTermDebt__1) == false) {
            return false;
        }
        LongTermDebt__1 rhs = ((LongTermDebt__1) other);
