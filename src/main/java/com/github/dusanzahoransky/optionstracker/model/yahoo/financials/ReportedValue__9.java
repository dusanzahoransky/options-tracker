...
public class ReportedValue__9 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__9.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__9) == false) {
            return false;
        }
        ReportedValue__9 rhs = ((ReportedValue__9) other);
