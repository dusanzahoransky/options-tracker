...
public class RegularMarketVolume__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketVolume__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketVolume__1) == false) {
            return false;
        }
        RegularMarketVolume__1 rhs = ((RegularMarketVolume__1) other);
