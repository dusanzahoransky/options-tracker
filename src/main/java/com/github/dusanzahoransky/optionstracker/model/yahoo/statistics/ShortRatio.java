...
public class ShortRatio {
    ...
    public String toString() {
        ...
        sb.append(ShortRatio.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ShortRatio) == false) {
            return false;
        }
        ShortRatio rhs = ((ShortRatio) other);
