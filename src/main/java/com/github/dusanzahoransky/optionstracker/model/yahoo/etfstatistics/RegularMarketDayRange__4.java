...
public class RegularMarketDayRange__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayRange__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayRange__4) == false) {
            return false;
        }
        RegularMarketDayRange__4 rhs = ((RegularMarketDayRange__4) other);
