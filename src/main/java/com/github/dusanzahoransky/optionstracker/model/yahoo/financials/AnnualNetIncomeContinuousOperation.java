...
public class AnnualNetIncomeContinuousOperation {
    ...
    private ReportedValue__20 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__20 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__20 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualNetIncomeContinuousOperation.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualNetIncomeContinuousOperation) == false) {
            return false;
        }
        AnnualNetIncomeContinuousOperation rhs = ((AnnualNetIncomeContinuousOperation) other);
