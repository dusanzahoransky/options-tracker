...
public class AnnualCapitalStock {
    ...
    public String toString() {
        ...
        sb.append(AnnualCapitalStock.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCapitalStock) == false) {
            return false;
        }
        AnnualCapitalStock rhs = ((AnnualCapitalStock) other);
