...
public class ThreeMonth__2 {
    ...
    public String toString() {
        ...
        sb.append(ThreeMonth__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThreeMonth__2) == false) {
            return false;
        }
        ThreeMonth__2 rhs = ((ThreeMonth__2) other);
