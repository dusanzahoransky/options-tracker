...
public class RegularMarketDayLow__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow__1) == false) {
            return false;
        }
        RegularMarketDayLow__1 rhs = ((RegularMarketDayLow__1) other);
