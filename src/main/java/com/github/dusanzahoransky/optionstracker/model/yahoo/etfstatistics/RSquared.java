...
public class RSquared {
    ...
    public String toString() {
        ...
        sb.append(RSquared.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RSquared) == false) {
            return false;
        }
        RSquared rhs = ((RSquared) other);
