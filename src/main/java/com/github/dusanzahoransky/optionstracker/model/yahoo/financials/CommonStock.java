...
public class CommonStock {
    ...
    public String toString() {
        ...
        sb.append(CommonStock.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CommonStock) == false) {
            return false;
        }
        CommonStock rhs = ((CommonStock) other);
