...
public class AnnualDilutedEP {
    ...
    private ReportedValue__24 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__24 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__24 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualDilutedEP.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualDilutedEP) == false) {
            return false;
        }
        AnnualDilutedEP rhs = ((AnnualDilutedEP) other);
