...
public class TargetHighPrice {
    ...
    public String toString() {
        ...
        sb.append(TargetHighPrice.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TargetHighPrice) == false) {
            return false;
        }
        TargetHighPrice rhs = ((TargetHighPrice) other);
