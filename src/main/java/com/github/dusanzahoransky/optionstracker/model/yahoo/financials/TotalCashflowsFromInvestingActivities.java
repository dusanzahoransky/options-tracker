...
public class TotalCashflowsFromInvestingActivities {
    ...
    public String toString() {
        ...
        sb.append(TotalCashflowsFromInvestingActivities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCashflowsFromInvestingActivities) == false) {
            return false;
        }
        TotalCashflowsFromInvestingActivities rhs = ((TotalCashflowsFromInvestingActivities) other);
