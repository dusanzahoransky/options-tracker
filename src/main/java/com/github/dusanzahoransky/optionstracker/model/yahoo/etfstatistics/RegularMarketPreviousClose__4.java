...
public class RegularMarketPreviousClose__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose__4) == false) {
            return false;
        }
        RegularMarketPreviousClose__4 rhs = ((RegularMarketPreviousClose__4) other);
