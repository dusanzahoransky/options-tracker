...
public class RegularMarketDayHigh__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh__3) == false) {
            return false;
        }
        RegularMarketDayHigh__3 rhs = ((RegularMarketDayHigh__3) other);
