...
public class ChangeToOperatingActivities {
    ...
    public String toString() {
        ...
        sb.append(ChangeToOperatingActivities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeToOperatingActivities) == false) {
            return false;
        }
        ChangeToOperatingActivities rhs = ((ChangeToOperatingActivities) other);
