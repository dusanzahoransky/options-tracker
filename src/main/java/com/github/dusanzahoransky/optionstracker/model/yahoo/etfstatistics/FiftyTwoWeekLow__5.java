...
public class FiftyTwoWeekLow__5 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLow__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLow__5) == false) {
            return false;
        }
        FiftyTwoWeekLow__5 rhs = ((FiftyTwoWeekLow__5) other);
