...
public class RegularMarketTime__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketTime__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketTime__5) == false) {
            return false;
        }
        RegularMarketTime__5 rhs = ((RegularMarketTime__5) other);
