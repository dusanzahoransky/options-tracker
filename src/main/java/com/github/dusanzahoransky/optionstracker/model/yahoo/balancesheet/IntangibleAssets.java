...
public class IntangibleAssets {
    ...
    public String toString() {
        ...
        sb.append(IntangibleAssets.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IntangibleAssets) == false) {
            return false;
        }
        IntangibleAssets rhs = ((IntangibleAssets) other);
