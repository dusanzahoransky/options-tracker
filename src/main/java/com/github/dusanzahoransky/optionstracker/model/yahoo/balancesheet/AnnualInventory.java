...
public class AnnualInventory {
    ...
    public String toString() {
        ...
        sb.append(AnnualInventory.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualInventory) == false) {
            return false;
        }
        AnnualInventory rhs = ((AnnualInventory) other);
