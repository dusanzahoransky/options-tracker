...
public class FinancialsResponse {
    ...
    private IncomeStatementHistory__1 incomeStatementHistory;
    ...
    @JsonProperty("incomeStatementHistory")
    public IncomeStatementHistory__1 getIncomeStatementHistory() {
        return incomeStatementHistory;
    }

    @JsonProperty("incomeStatementHistory")
    public void setIncomeStatementHistory(IncomeStatementHistory__1 incomeStatementHistory) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FinancialsResponse) == false) {
            return false;
        }
        FinancialsResponse rhs = ((FinancialsResponse) other);
