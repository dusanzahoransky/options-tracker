...
public class TotalStockholderEquity__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalStockholderEquity__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalStockholderEquity__1) == false) {
            return false;
        }
        TotalStockholderEquity__1 rhs = ((TotalStockholderEquity__1) other);
