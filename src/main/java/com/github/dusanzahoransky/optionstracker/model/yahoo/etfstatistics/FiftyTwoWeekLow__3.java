...
public class FiftyTwoWeekLow__3 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLow__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLow__3) == false) {
            return false;
        }
        FiftyTwoWeekLow__3 rhs = ((FiftyTwoWeekLow__3) other);
