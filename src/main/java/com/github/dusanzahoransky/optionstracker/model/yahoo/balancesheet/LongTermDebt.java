...
public class LongTermDebt {
    ...
    public String toString() {
        ...
        sb.append(LongTermDebt.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LongTermDebt) == false) {
            return false;
        }
        LongTermDebt rhs = ((LongTermDebt) other);
