...
public class SummaryDetail {
    ...
    private PriceHint__2 priceHint;
    ...
    private PriceToSalesTrailing12Months__1 priceToSalesTrailing12Months;
    @JsonProperty("dayLow")
    ...
    private ForwardPE__1 forwardPE;
    @JsonProperty("maxAge")
    private Long maxAge;
    ...
    @JsonProperty("yield")
    public Yield__1 getYield() {
        return yield;
    }

    @JsonProperty("yield")
    public void setYield(Yield__1 yield) {
        this.yield = yield;
    }
    ...
    @JsonProperty("beta")
    public Beta__1 getBeta() {
        return beta;
    }

    @JsonProperty("beta")
    public void setBeta(Beta__1 beta) {
        this.beta = beta;
    }
    ...
    @JsonProperty("priceHint")
    public PriceHint__2 getPriceHint() {
        return priceHint;
    }

    @JsonProperty("priceHint")
    public void setPriceHint(PriceHint__2 priceHint) {
    ...
    @JsonProperty("priceToSalesTrailing12Months")
    public PriceToSalesTrailing12Months__1 getPriceToSalesTrailing12Months() {
        return priceToSalesTrailing12Months;
    }

    @JsonProperty("priceToSalesTrailing12Months")
    public void setPriceToSalesTrailing12Months(PriceToSalesTrailing12Months__1 priceToSalesTrailing12Months) {
    ...
    @JsonProperty("forwardPE")
    public ForwardPE__1 getForwardPE() {
        return forwardPE;
    }

    @JsonProperty("forwardPE")
    public void setForwardPE(ForwardPE__1 forwardPE) {
