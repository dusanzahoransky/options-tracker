...
public class FundOwnership {
    ...
    public String toString() {
        ...
        sb.append(FundOwnership.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("maxAge");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FundOwnership) == false) {
            return false;
        }
        FundOwnership rhs = ((FundOwnership) other);
