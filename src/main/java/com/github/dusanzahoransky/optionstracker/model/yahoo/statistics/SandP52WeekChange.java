...
public class SandP52WeekChange {
    ...
    public String toString() {
        ...
        sb.append(SandP52WeekChange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SandP52WeekChange) == false) {
            return false;
        }
        SandP52WeekChange rhs = ((SandP52WeekChange) other);
