...
public class PositionDirect {
    ...
    public String toString() {
        ...
        sb.append(PositionDirect.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionDirect) == false) {
            return false;
        }
        PositionDirect rhs = ((PositionDirect) other);
