...
public class RegularMarketDayLow__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow__4) == false) {
            return false;
        }
        RegularMarketDayLow__4 rhs = ((RegularMarketDayLow__4) other);
