...
public class PctHeld {
    ...
    public String toString() {
        ...
        sb.append(PctHeld.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PctHeld) == false) {
            return false;
        }
        PctHeld rhs = ((PctHeld) other);
