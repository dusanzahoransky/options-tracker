...
public class MostRecentQuarter {
    ...
    public String toString() {
        ...
        sb.append(MostRecentQuarter.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MostRecentQuarter) == false) {
            return false;
        }
        MostRecentQuarter rhs = ((MostRecentQuarter) other);
