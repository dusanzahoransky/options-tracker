...
public class _60daysAgo {
    ...
    public String toString() {
        ...
        sb.append(_60daysAgo.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _60daysAgo) == false) {
            return false;
        }
        _60daysAgo rhs = ((_60daysAgo) other);
