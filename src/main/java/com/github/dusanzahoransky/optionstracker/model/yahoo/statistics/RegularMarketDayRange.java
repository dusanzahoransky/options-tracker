...
public class RegularMarketDayRange {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayRange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayRange) == false) {
            return false;
        }
        RegularMarketDayRange rhs = ((RegularMarketDayRange) other);
