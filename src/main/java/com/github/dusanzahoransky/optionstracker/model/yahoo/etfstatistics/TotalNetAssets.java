...
public class TotalNetAssets {
    ...
    public String toString() {
        ...
        sb.append(TotalNetAssets.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalNetAssets) == false) {
            return false;
        }
        TotalNetAssets rhs = ((TotalNetAssets) other);
