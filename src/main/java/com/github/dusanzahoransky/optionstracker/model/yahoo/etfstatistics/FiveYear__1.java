...
public class FiveYear__1 {
    ...
    public String toString() {
        ...
        sb.append(FiveYear__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiveYear__1) == false) {
            return false;
        }
        FiveYear__1 rhs = ((FiveYear__1) other);
