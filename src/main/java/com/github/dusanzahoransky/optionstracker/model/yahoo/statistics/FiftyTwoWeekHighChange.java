...
public class FiftyTwoWeekHighChange {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChange) == false) {
            return false;
        }
        FiftyTwoWeekHighChange rhs = ((FiftyTwoWeekHighChange) other);
