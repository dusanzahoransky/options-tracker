...
public class OtherStockholderEquity__1 {
    ...
    public String toString() {
        ...
        sb.append(OtherStockholderEquity__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherStockholderEquity__1) == false) {
            return false;
        }
        OtherStockholderEquity__1 rhs = ((OtherStockholderEquity__1) other);
