...
public class FiftyTwoWeekLowChange {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChange) == false) {
            return false;
        }
        FiftyTwoWeekLowChange rhs = ((FiftyTwoWeekLowChange) other);
