...
public class OperatingCashflow {
    ...
    public String toString() {
        ...
        sb.append(OperatingCashflow.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OperatingCashflow) == false) {
            return false;
        }
        OperatingCashflow rhs = ((OperatingCashflow) other);
