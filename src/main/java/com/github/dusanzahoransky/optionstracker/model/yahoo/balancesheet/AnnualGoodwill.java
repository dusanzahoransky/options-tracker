...
public class AnnualGoodwill {
    ...
    public String toString() {
        ...
        sb.append(AnnualGoodwill.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualGoodwill) == false) {
            return false;
        }
        AnnualGoodwill rhs = ((AnnualGoodwill) other);
