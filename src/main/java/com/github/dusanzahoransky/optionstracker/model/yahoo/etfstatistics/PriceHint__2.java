...
public class PriceHint__2 {
    ...
    public String toString() {
        ...
        sb.append(PriceHint__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceHint__2) == false) {
            return false;
        }
        PriceHint__2 rhs = ((PriceHint__2) other);
