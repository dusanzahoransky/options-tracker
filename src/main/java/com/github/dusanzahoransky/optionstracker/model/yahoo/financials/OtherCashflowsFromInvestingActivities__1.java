...
public class OtherCashflowsFromInvestingActivities__1 {
    ...
    public String toString() {
        ...
        sb.append(OtherCashflowsFromInvestingActivities__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCashflowsFromInvestingActivities__1) == false) {
            return false;
        }
        OtherCashflowsFromInvestingActivities__1 rhs = ((OtherCashflowsFromInvestingActivities__1) other);
