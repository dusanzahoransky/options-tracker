...
public class CostOfRevenue {
    ...
    public String toString() {
        ...
        sb.append(CostOfRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CostOfRevenue) == false) {
            return false;
        }
        CostOfRevenue rhs = ((CostOfRevenue) other);
