...
public class Ownership__1 {

    @JsonProperty("maxAge")
    private Long maxAge;
    @JsonProperty("reportDate")
    private ReportDate__1 reportDate;
    @JsonProperty("organization")
    private String organization;
    @JsonProperty("pctHeld")
    private PctHeld__1 pctHeld;
    ...
    @JsonProperty("reportDate")
    public ReportDate__1 getReportDate() {
        return reportDate;
    }

    @JsonProperty("reportDate")
    public void setReportDate(ReportDate__1 reportDate) {
    ...
    @JsonProperty("pctHeld")
    public PctHeld__1 getPctHeld() {
        return pctHeld;
    }

    @JsonProperty("pctHeld")
    public void setPctHeld(PctHeld__1 pctHeld) {
    ...
    public String toString() {
        ...
        sb.append(Ownership__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("maxAge");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ownership__1) == false) {
            return false;
        }
        Ownership__1 rhs = ((Ownership__1) other);
