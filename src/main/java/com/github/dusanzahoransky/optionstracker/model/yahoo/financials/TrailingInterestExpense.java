...
public class TrailingInterestExpense {
    ...
    private ReportedValue__18 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__18 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__18 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingInterestExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingInterestExpense) == false) {
            return false;
        }
        TrailingInterestExpense rhs = ((TrailingInterestExpense) other);
