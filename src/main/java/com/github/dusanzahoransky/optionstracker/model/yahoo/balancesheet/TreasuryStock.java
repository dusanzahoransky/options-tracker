...
public class TreasuryStock {
    ...
    public String toString() {
        ...
        sb.append(TreasuryStock.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TreasuryStock) == false) {
            return false;
        }
        TreasuryStock rhs = ((TreasuryStock) other);
