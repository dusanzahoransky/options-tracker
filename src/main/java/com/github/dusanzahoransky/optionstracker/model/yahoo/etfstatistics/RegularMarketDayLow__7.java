...
public class RegularMarketDayLow__7 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow__7 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow__7) == false) {
            return false;
        }
        RegularMarketDayLow__7 rhs = ((RegularMarketDayLow__7) other);
