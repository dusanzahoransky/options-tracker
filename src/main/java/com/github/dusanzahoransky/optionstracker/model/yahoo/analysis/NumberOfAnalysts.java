...
public class NumberOfAnalysts {
    ...
    public String toString() {
        ...
        sb.append(NumberOfAnalysts.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NumberOfAnalysts) == false) {
            return false;
        }
        NumberOfAnalysts rhs = ((NumberOfAnalysts) other);
