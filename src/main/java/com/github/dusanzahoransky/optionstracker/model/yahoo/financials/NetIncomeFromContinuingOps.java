...
public class NetIncomeFromContinuingOps {
    ...
    public String toString() {
        ...
        sb.append(NetIncomeFromContinuingOps.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncomeFromContinuingOps) == false) {
            return false;
        }
        NetIncomeFromContinuingOps rhs = ((NetIncomeFromContinuingOps) other);
