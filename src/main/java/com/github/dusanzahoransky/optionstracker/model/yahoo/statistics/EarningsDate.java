...
public class EarningsDate {
    ...
    public String toString() {
        ...
        sb.append(EarningsDate.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarningsDate) == false) {
            return false;
        }
        EarningsDate rhs = ((EarningsDate) other);
