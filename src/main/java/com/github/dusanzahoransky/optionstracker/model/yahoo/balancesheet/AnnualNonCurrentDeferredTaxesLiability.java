...
public class AnnualNonCurrentDeferredTaxesLiability {
    ...
    public String toString() {
        ...
        sb.append(AnnualNonCurrentDeferredTaxesLiability.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualNonCurrentDeferredTaxesLiability) == false) {
            return false;
        }
        AnnualNonCurrentDeferredTaxesLiability rhs = ((AnnualNonCurrentDeferredTaxesLiability) other);
