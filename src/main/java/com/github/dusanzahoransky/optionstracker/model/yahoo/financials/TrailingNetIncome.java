...
public class TrailingNetIncome {
    ...
    private ReportedValue__6 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__6 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__6 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingNetIncome.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingNetIncome) == false) {
            return false;
        }
        TrailingNetIncome rhs = ((TrailingNetIncome) other);
