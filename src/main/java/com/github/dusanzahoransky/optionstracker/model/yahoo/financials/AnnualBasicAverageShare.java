...
public class AnnualBasicAverageShare {
    ...
    private ReportedValue__9 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__9 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__9 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualBasicAverageShare.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualBasicAverageShare) == false) {
            return false;
        }
        AnnualBasicAverageShare rhs = ((AnnualBasicAverageShare) other);
