...
public class RegularMarketPrice__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPrice__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPrice__5) == false) {
            return false;
        }
        RegularMarketPrice__5 rhs = ((RegularMarketPrice__5) other);
