...
public class RegularMarketOpen__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen__3) == false) {
            return false;
        }
        RegularMarketOpen__3 rhs = ((RegularMarketOpen__3) other);
