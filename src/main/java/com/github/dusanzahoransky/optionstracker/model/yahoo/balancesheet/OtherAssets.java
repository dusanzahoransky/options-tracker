...
public class OtherAssets {
    ...
    public String toString() {
        ...
        sb.append(OtherAssets.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherAssets) == false) {
            return false;
        }
        OtherAssets rhs = ((OtherAssets) other);
