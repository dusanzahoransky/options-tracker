...
public class AnnualOtherIncomeExpense {
    ...
    private ReportedValue__1 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__1 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__1 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualOtherIncomeExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualOtherIncomeExpense) == false) {
            return false;
        }
        AnnualOtherIncomeExpense rhs = ((AnnualOtherIncomeExpense) other);
