...
public class BookValue {
    ...
    public String toString() {
        ...
        sb.append(BookValue.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BookValue) == false) {
            return false;
        }
        BookValue rhs = ((BookValue) other);
