...
public class TrailingTotalRevenue {
    ...
    private ReportedValue__25 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__25 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__25 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingTotalRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingTotalRevenue) == false) {
            return false;
        }
        TrailingTotalRevenue rhs = ((TrailingTotalRevenue) other);
