...
public class RegularMarketDayRange__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayRange__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayRange__1) == false) {
            return false;
        }
        RegularMarketDayRange__1 rhs = ((RegularMarketDayRange__1) other);
