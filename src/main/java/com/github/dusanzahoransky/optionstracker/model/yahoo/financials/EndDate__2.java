...
public class EndDate__2 {
    ...
    public String toString() {
        ...
        sb.append(EndDate__2.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EndDate__2) == false) {
            return false;
        }
        EndDate__2 rhs = ((EndDate__2) other);
