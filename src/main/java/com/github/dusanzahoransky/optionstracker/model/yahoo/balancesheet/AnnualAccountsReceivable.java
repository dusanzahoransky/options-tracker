...
public class AnnualAccountsReceivable {
    ...
    public String toString() {
        ...
        sb.append(AnnualAccountsReceivable.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualAccountsReceivable) == false) {
            return false;
        }
        AnnualAccountsReceivable rhs = ((AnnualAccountsReceivable) other);
