...
public class ReportedValue__20 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__20.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__20) == false) {
            return false;
        }
        ReportedValue__20 rhs = ((ReportedValue__20) other);
