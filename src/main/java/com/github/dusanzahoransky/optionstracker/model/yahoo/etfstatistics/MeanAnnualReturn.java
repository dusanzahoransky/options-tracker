...
public class MeanAnnualReturn {
    ...
    public String toString() {
        ...
        sb.append(MeanAnnualReturn.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MeanAnnualReturn) == false) {
            return false;
        }
        MeanAnnualReturn rhs = ((MeanAnnualReturn) other);
