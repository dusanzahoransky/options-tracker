...
public class AskSize {
    ...
    public String toString() {
        ...
        sb.append(AskSize.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AskSize) == false) {
            return false;
        }
        AskSize rhs = ((AskSize) other);
