...
public class _52WeekChange {
    ...
    public String toString() {
        ...
        sb.append(_52WeekChange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _52WeekChange) == false) {
            return false;
        }
        _52WeekChange rhs = ((_52WeekChange) other);
