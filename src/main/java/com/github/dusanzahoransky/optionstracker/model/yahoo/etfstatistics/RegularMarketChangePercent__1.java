...
public class RegularMarketChangePercent__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChangePercent__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChangePercent__1) == false) {
            return false;
        }
        RegularMarketChangePercent__1 rhs = ((RegularMarketChangePercent__1) other);
