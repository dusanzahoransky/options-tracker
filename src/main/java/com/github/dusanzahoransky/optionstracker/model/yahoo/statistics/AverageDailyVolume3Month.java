...
public class AverageDailyVolume3Month {
    ...
    @JsonProperty("longFmt")
    public void setDoubleFmt(String longFmt) {
    ...
    public String toString() {
        ...
        sb.append(AverageDailyVolume3Month.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AverageDailyVolume3Month) == false) {
            return false;
        }
        AverageDailyVolume3Month rhs = ((AverageDailyVolume3Month) other);
