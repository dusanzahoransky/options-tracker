...
public class FiftyTwoWeekHigh__2 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHigh__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHigh__2) == false) {
            return false;
        }
        FiftyTwoWeekHigh__2 rhs = ((FiftyTwoWeekHigh__2) other);
