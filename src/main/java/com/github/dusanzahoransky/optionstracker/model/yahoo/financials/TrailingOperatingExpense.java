...
public class TrailingOperatingExpense {
    ...
    private ReportedValue__32 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__32 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__32 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingOperatingExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingOperatingExpense) == false) {
            return false;
        }
        TrailingOperatingExpense rhs = ((TrailingOperatingExpense) other);
