...
public class NetIncomeApplicableToCommonShares {
    ...
    public String toString() {
        ...
        sb.append(NetIncomeApplicableToCommonShares.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncomeApplicableToCommonShares) == false) {
            return false;
        }
        NetIncomeApplicableToCommonShares rhs = ((NetIncomeApplicableToCommonShares) other);
