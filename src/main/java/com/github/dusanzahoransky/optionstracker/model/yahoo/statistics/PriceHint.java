...
public class PriceHint {
    ...
    public String toString() {
        ...
        sb.append(PriceHint.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceHint) == false) {
            return false;
        }
        PriceHint rhs = ((PriceHint) other);
