...
public class PositionDirectDate {
    ...
    public String toString() {
        ...
        sb.append(PositionDirectDate.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionDirectDate) == false) {
            return false;
        }
        PositionDirectDate rhs = ((PositionDirectDate) other);
