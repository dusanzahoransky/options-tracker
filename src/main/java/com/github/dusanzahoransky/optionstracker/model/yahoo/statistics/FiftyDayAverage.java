...
public class FiftyDayAverage {
    ...
    public String toString() {
        ...
        sb.append(FiftyDayAverage.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyDayAverage) == false) {
            return false;
        }
        FiftyDayAverage rhs = ((FiftyDayAverage) other);
