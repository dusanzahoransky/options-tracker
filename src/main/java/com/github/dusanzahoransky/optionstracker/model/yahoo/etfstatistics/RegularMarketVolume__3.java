...
public class RegularMarketVolume__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketVolume__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketVolume__3) == false) {
            return false;
        }
        RegularMarketVolume__3 rhs = ((RegularMarketVolume__3) other);
