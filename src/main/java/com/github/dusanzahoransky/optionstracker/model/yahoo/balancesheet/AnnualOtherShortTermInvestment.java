...
public class AnnualOtherShortTermInvestment {
    ...
    public String toString() {
        ...
        sb.append(AnnualOtherShortTermInvestment.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualOtherShortTermInvestment) == false) {
            return false;
        }
        AnnualOtherShortTermInvestment rhs = ((AnnualOtherShortTermInvestment) other);
