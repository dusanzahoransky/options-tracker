...
public class TotalOtherIncomeExpenseNet {
    ...
    public String toString() {
        ...
        sb.append(TotalOtherIncomeExpenseNet.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalOtherIncomeExpenseNet) == false) {
            return false;
        }
        TotalOtherIncomeExpenseNet rhs = ((TotalOtherIncomeExpenseNet) other);
