...
public class FiftyTwoWeekHighChangePercent {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChangePercent.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChangePercent) == false) {
            return false;
        }
        FiftyTwoWeekHighChangePercent rhs = ((FiftyTwoWeekHighChangePercent) other);
