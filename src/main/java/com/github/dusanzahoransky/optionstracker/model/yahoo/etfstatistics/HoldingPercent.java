...
public class HoldingPercent {
    ...
    public String toString() {
        ...
        sb.append(HoldingPercent.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HoldingPercent) == false) {
            return false;
        }
        HoldingPercent rhs = ((HoldingPercent) other);
