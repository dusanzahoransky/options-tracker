...
public class RegularMarketPrice__6 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPrice__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPrice__6) == false) {
            return false;
        }
        RegularMarketPrice__6 rhs = ((RegularMarketPrice__6) other);
