...
public class FiftyTwoWeekLow__2 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLow__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLow__2) == false) {
            return false;
        }
        FiftyTwoWeekLow__2 rhs = ((FiftyTwoWeekLow__2) other);
