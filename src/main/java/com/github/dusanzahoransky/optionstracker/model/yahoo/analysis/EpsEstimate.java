...
public class EpsEstimate {
    ...
    public String toString() {
        ...
        sb.append(EpsEstimate.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EpsEstimate) == false) {
            return false;
        }
        EpsEstimate rhs = ((EpsEstimate) other);
