...
public class HeldPercentInsiders {
    ...
    public String toString() {
        ...
        sb.append(HeldPercentInsiders.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HeldPercentInsiders) == false) {
            return false;
        }
        HeldPercentInsiders rhs = ((HeldPercentInsiders) other);
