...
public class AnnualCashCashEquivalentsAndShortTermInvestment {
    ...
    public String toString() {
        ...
        sb.append(AnnualCashCashEquivalentsAndShortTermInvestment.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCashCashEquivalentsAndShortTermInvestment) == false) {
            return false;
        }
        AnnualCashCashEquivalentsAndShortTermInvestment rhs = ((AnnualCashCashEquivalentsAndShortTermInvestment) other);
