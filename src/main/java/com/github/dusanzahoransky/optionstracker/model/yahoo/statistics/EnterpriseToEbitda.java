...
public class EnterpriseToEbitda {
    ...
    public String toString() {
        ...
        sb.append(EnterpriseToEbitda.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EnterpriseToEbitda) == false) {
            return false;
        }
        EnterpriseToEbitda rhs = ((EnterpriseToEbitda) other);
