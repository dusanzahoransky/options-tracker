...
public class OtherCurrentLiab {
    ...
    public String toString() {
        ...
        sb.append(OtherCurrentLiab.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCurrentLiab) == false) {
            return false;
        }
        OtherCurrentLiab rhs = ((OtherCurrentLiab) other);
