...
public class BuyPercentInsiderShares {
    ...
    public String toString() {
        ...
        sb.append(BuyPercentInsiderShares.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BuyPercentInsiderShares) == false) {
            return false;
        }
        BuyPercentInsiderShares rhs = ((BuyPercentInsiderShares) other);
