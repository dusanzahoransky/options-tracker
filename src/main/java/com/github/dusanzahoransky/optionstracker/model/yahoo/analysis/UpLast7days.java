...
public class UpLast7days {
    ...
    public String toString() {
        ...
        sb.append(UpLast7days.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpLast7days) == false) {
            return false;
        }
        UpLast7days rhs = ((UpLast7days) other);
