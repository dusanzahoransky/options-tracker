...
public class IncomeStatementHistoryAnnual {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IncomeStatementHistoryAnnual) == false) {
            return false;
        }
        IncomeStatementHistoryAnnual rhs = ((IncomeStatementHistoryAnnual) other);
