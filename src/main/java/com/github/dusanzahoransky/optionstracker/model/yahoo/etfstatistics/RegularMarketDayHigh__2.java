...
public class RegularMarketDayHigh__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh__2) == false) {
            return false;
        }
        RegularMarketDayHigh__2 rhs = ((RegularMarketDayHigh__2) other);
