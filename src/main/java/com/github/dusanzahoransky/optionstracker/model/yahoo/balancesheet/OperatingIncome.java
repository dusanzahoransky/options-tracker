...
public class OperatingIncome {
    ...
    public String toString() {
        ...
        sb.append(OperatingIncome.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OperatingIncome) == false) {
            return false;
        }
        OperatingIncome rhs = ((OperatingIncome) other);
