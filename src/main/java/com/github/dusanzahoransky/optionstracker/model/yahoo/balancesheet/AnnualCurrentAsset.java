...
public class AnnualCurrentAsset {
    ...
    public String toString() {
        ...
        sb.append(AnnualCurrentAsset.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCurrentAsset) == false) {
            return false;
        }
        AnnualCurrentAsset rhs = ((AnnualCurrentAsset) other);
