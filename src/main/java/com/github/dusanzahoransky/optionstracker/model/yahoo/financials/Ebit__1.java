...
public class Ebit__1 {
    ...
    public String toString() {
        ...
        sb.append(Ebit__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ebit__1) == false) {
            return false;
        }
        Ebit__1 rhs = ((Ebit__1) other);
