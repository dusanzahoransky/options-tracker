...
public class BidSize {
    ...
    public String toString() {
        ...
        sb.append(BidSize.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BidSize) == false) {
            return false;
        }
        BidSize rhs = ((BidSize) other);
