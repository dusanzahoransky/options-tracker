...
public class RegularMarketPreviousClose__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose__2) == false) {
            return false;
        }
        RegularMarketPreviousClose__2 rhs = ((RegularMarketPreviousClose__2) other);
