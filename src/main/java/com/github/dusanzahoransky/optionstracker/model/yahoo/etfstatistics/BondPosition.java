...
public class BondPosition {
    ...
    public String toString() {
        ...
        sb.append(BondPosition.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BondPosition) == false) {
            return false;
        }
        BondPosition rhs = ((BondPosition) other);
