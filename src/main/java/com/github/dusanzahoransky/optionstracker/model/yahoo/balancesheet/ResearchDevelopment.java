...
public class ResearchDevelopment {
    ...
    public String toString() {
        ...
        sb.append(ResearchDevelopment.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResearchDevelopment) == false) {
            return false;
        }
        ResearchDevelopment rhs = ((ResearchDevelopment) other);
