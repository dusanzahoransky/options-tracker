...
public class PreviousClose {
    ...
    public String toString() {
        ...
        sb.append(PreviousClose.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PreviousClose) == false) {
            return false;
        }
        PreviousClose rhs = ((PreviousClose) other);
