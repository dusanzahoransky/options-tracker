...
public class GrossMargins {
    ...
    public String toString() {
        ...
        sb.append(GrossMargins.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GrossMargins) == false) {
            return false;
        }
        GrossMargins rhs = ((GrossMargins) other);
