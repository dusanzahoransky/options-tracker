...
public class FiftyTwoWeekHighChangePercent__1 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChangePercent__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChangePercent__1) == false) {
            return false;
        }
        FiftyTwoWeekHighChangePercent__1 rhs = ((FiftyTwoWeekHighChangePercent__1) other);
