...
public class ReportedValue__4 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__4.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__4) == false) {
            return false;
        }
        ReportedValue__4 rhs = ((ReportedValue__4) other);
