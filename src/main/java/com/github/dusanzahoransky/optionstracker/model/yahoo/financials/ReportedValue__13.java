...
public class ReportedValue__13 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__13.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__13) == false) {
            return false;
        }
        ReportedValue__13 rhs = ((ReportedValue__13) other);
