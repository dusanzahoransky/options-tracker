...
public class TrailingGrossProfit {
    ...
    private ReportedValue__5 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__5 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__5 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingGrossProfit.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingGrossProfit) == false) {
            return false;
        }
        TrailingGrossProfit rhs = ((TrailingGrossProfit) other);
