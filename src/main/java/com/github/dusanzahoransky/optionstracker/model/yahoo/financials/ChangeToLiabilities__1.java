...
public class ChangeToLiabilities__1 {
    ...
    public String toString() {
        ...
        sb.append(ChangeToLiabilities__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeToLiabilities__1) == false) {
            return false;
        }
        ChangeToLiabilities__1 rhs = ((ChangeToLiabilities__1) other);
