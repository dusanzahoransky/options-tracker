...
public class Ytd__1 {
    ...
    public String toString() {
        ...
        sb.append(Ytd__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ytd__1) == false) {
            return false;
        }
        Ytd__1 rhs = ((Ytd__1) other);
