...
public class EarningsAverage {
    ...
    public String toString() {
        ...
        sb.append(EarningsAverage.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarningsAverage) == false) {
            return false;
        }
        EarningsAverage rhs = ((EarningsAverage) other);
