...
public class IncomeBeforeTax__1 {
    ...
    public String toString() {
        ...
        sb.append(IncomeBeforeTax__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IncomeBeforeTax__1) == false) {
            return false;
        }
        IncomeBeforeTax__1 rhs = ((IncomeBeforeTax__1) other);
