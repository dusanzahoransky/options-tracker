...
public class NextFiscalYearEnd {
    ...
    public String toString() {
        ...
        sb.append(NextFiscalYearEnd.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NextFiscalYearEnd) == false) {
            return false;
        }
        NextFiscalYearEnd rhs = ((NextFiscalYearEnd) other);
