...
public class RegularMarketTime {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketTime.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketTime) == false) {
            return false;
        }
        RegularMarketTime rhs = ((RegularMarketTime) other);
