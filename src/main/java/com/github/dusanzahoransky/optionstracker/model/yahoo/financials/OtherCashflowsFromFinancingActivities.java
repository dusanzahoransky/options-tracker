...
public class OtherCashflowsFromFinancingActivities {
    ...
    public String toString() {
        ...
        sb.append(OtherCashflowsFromFinancingActivities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCashflowsFromFinancingActivities) == false) {
            return false;
        }
        OtherCashflowsFromFinancingActivities rhs = ((OtherCashflowsFromFinancingActivities) other);
