...
public class RegularMarketOpen__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen__5) == false) {
            return false;
        }
        RegularMarketOpen__5 rhs = ((RegularMarketOpen__5) other);
