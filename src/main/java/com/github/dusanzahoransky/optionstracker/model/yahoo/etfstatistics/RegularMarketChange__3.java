...
public class RegularMarketChange__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChange__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChange__3) == false) {
            return false;
        }
        RegularMarketChange__3 rhs = ((RegularMarketChange__3) other);
