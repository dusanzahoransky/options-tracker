...
public class CapitalExpenditures {
    ...
    public String toString() {
        ...
        sb.append(CapitalExpenditures.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CapitalExpenditures) == false) {
            return false;
        }
        CapitalExpenditures rhs = ((CapitalExpenditures) other);
