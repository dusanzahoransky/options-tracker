...
public class ForwardPE {
    ...
    public String toString() {
        ...
        sb.append(ForwardPE.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ForwardPE) == false) {
            return false;
        }
        ForwardPE rhs = ((ForwardPE) other);
