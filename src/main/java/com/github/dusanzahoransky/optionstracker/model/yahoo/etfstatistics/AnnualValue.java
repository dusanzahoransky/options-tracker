...
public class AnnualValue {
    ...
    public String toString() {
        ...
        sb.append(AnnualValue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualValue) == false) {
            return false;
        }
        AnnualValue rhs = ((AnnualValue) other);
