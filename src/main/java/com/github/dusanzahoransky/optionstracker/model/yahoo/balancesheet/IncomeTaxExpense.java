...
public class IncomeTaxExpense {
    ...
    public String toString() {
        ...
        sb.append(IncomeTaxExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IncomeTaxExpense) == false) {
            return false;
        }
        IncomeTaxExpense rhs = ((IncomeTaxExpense) other);
