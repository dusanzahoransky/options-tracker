...
public class MarketCap__1 {
    ...
    public String toString() {
        ...
        sb.append(MarketCap__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MarketCap__1) == false) {
            return false;
        }
        MarketCap__1 rhs = ((MarketCap__1) other);
