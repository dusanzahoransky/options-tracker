...
public class TotalOtherIncomeExpenseNet__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalOtherIncomeExpenseNet__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalOtherIncomeExpenseNet__1) == false) {
            return false;
        }
        TotalOtherIncomeExpenseNet__1 rhs = ((TotalOtherIncomeExpenseNet__1) other);
