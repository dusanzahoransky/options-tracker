...
public class ConsumerDefensive {
    ...
    public String toString() {
        ...
        sb.append(ConsumerDefensive.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConsumerDefensive) == false) {
            return false;
        }
        ConsumerDefensive rhs = ((ConsumerDefensive) other);
