...
public class ResearchDevelopment__1 {
    ...
    public String toString() {
        ...
        sb.append(ResearchDevelopment__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResearchDevelopment__1) == false) {
            return false;
        }
        ResearchDevelopment__1 rhs = ((ResearchDevelopment__1) other);
