...
public class ChangeToLiabilities {
    ...
    public String toString() {
        ...
        sb.append(ChangeToLiabilities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeToLiabilities) == false) {
            return false;
        }
        ChangeToLiabilities rhs = ((ChangeToLiabilities) other);
