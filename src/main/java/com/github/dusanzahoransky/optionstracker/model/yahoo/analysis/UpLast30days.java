...
public class UpLast30days {
    ...
    public String toString() {
        ...
        sb.append(UpLast30days.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpLast30days) == false) {
            return false;
        }
        UpLast30days rhs = ((UpLast30days) other);
