...
public class FiftyTwoWeekLowChange__2 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChange__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChange__2) == false) {
            return false;
        }
        FiftyTwoWeekLowChange__2 rhs = ((FiftyTwoWeekLowChange__2) other);
