...
public class PreMarketChangePercent {
    ...
    public String toString() {
        ...
        sb.append(PreMarketChangePercent.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PreMarketChangePercent) == false) {
            return false;
        }
        PreMarketChangePercent rhs = ((PreMarketChangePercent) other);
