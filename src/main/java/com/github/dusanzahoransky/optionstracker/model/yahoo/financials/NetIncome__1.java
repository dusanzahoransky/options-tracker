...
public class NetIncome__1 {
    ...
    public String toString() {
        ...
        sb.append(NetIncome__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncome__1) == false) {
            return false;
        }
        NetIncome__1 rhs = ((NetIncome__1) other);
