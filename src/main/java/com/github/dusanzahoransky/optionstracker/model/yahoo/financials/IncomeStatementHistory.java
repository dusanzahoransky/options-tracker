...
public class IncomeStatementHistory {
    ...
    private NetIncome__1 netIncome;
    ...
    @JsonProperty("netIncome")
    public NetIncome__1 getNetIncome() {
        return netIncome;
    }

    @JsonProperty("netIncome")
    public void setNetIncome(NetIncome__1 netIncome) {
    ...
    @JsonProperty("endDate")
    public EndDate__2 getEndDate() {
        return endDate;
    }

    @JsonProperty("endDate")
    public void setEndDate(EndDate__2 endDate) {
