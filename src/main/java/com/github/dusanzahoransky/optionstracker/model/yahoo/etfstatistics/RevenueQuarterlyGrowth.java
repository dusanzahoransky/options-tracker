...
public class RevenueQuarterlyGrowth {
    ...
    public String toString() {
        ...
        sb.append(RevenueQuarterlyGrowth.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RevenueQuarterlyGrowth) == false) {
            return false;
        }
