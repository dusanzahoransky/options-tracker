...
public class RegularMarketOpen__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen__2) == false) {
            return false;
        }
        RegularMarketOpen__2 rhs = ((RegularMarketOpen__2) other);
