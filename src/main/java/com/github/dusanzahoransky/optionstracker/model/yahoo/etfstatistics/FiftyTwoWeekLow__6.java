...
public class FiftyTwoWeekLow__6 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLow__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLow__6) == false) {
            return false;
        }
        FiftyTwoWeekLow__6 rhs = ((FiftyTwoWeekLow__6) other);
