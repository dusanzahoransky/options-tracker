...
public class ReportedValue__10 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__10.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__10) == false) {
            return false;
        }
        ReportedValue__10 rhs = ((ReportedValue__10) other);
