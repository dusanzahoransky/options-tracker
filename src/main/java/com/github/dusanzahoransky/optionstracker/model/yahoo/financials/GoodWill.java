...
public class GoodWill {
    ...
    public String toString() {
        ...
        sb.append(GoodWill.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GoodWill) == false) {
            return false;
        }
        GoodWill rhs = ((GoodWill) other);
