...
public class LastBearMkt {
    ...
    public String toString() {
        ...
        sb.append(LastBearMkt.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LastBearMkt) == false) {
            return false;
        }
        LastBearMkt rhs = ((LastBearMkt) other);
