...
public class RegularMarketDayHigh__7 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh__7 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh__7) == false) {
            return false;
        }
        RegularMarketDayHigh__7 rhs = ((RegularMarketDayHigh__7) other);
