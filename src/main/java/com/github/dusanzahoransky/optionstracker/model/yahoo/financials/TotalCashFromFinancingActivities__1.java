...
public class TotalCashFromFinancingActivities__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalCashFromFinancingActivities__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCashFromFinancingActivities__1) == false) {
            return false;
        }
        TotalCashFromFinancingActivities__1 rhs = ((TotalCashFromFinancingActivities__1) other);
