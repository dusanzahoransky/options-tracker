...
public class AnnualSellingGeneralAndAdministration {
    ...
    private ReportedValue__10 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__10 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__10 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualSellingGeneralAndAdministration.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualSellingGeneralAndAdministration) == false) {
            return false;
        }
        AnnualSellingGeneralAndAdministration rhs = ((AnnualSellingGeneralAndAdministration) other);
