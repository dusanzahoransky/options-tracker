...
public class FiftyTwoWeekHighChange__5 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChange__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChange__5) == false) {
            return false;
        }
        FiftyTwoWeekHighChange__5 rhs = ((FiftyTwoWeekHighChange__5) other);
