...
public class RegularMarketPreviousClose {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose) == false) {
            return false;
        }
        RegularMarketPreviousClose rhs = ((RegularMarketPreviousClose) other);
