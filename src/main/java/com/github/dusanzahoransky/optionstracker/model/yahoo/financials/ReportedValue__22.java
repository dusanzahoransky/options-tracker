...
public class ReportedValue__22 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__22.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__22) == false) {
            return false;
        }
        ReportedValue__22 rhs = ((ReportedValue__22) other);
