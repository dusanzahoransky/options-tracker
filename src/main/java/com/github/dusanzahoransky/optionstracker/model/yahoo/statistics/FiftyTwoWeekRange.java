...
public class FiftyTwoWeekRange {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekRange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekRange) == false) {
            return false;
        }
        FiftyTwoWeekRange rhs = ((FiftyTwoWeekRange) other);
