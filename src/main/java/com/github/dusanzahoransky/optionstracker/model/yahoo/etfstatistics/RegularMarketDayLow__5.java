...
public class RegularMarketDayLow__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow__5) == false) {
            return false;
        }
        RegularMarketDayLow__5 rhs = ((RegularMarketDayLow__5) other);
