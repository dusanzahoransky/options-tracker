...
public class AverageVolume10days {
    ...
    public String toString() {
        ...
        sb.append(AverageVolume10days.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AverageVolume10days) == false) {
            return false;
        }
        AverageVolume10days rhs = ((AverageVolume10days) other);
