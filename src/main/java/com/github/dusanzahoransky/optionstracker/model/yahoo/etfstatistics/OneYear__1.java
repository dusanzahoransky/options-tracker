...
public class OneYear__1 {
    ...
    public String toString() {
        ...
        sb.append(OneYear__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OneYear__1) == false) {
            return false;
        }
        OneYear__1 rhs = ((OneYear__1) other);
