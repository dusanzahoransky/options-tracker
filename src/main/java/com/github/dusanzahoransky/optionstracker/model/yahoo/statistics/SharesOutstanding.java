...
public class SharesOutstanding {
    ...
    public String toString() {
        ...
        sb.append(SharesOutstanding.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SharesOutstanding) == false) {
            return false;
        }
        SharesOutstanding rhs = ((SharesOutstanding) other);
