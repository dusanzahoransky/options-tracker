...
public class ThreeYear {
    ...
    public String toString() {
        ...
        sb.append(ThreeYear.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThreeYear) == false) {
            return false;
        }
        ThreeYear rhs = ((ThreeYear) other);
