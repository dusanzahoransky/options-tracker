...
public class FiftyTwoWeekHigh__6 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHigh__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHigh__6) == false) {
            return false;
        }
        FiftyTwoWeekHigh__6 rhs = ((FiftyTwoWeekHigh__6) other);
