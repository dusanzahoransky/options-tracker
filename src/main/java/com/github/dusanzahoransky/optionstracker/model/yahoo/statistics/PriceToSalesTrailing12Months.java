...
public class PriceToSalesTrailing12Months {
    ...
    public String toString() {
        ...
        sb.append(PriceToSalesTrailing12Months.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceToSalesTrailing12Months) == false) {
            return false;
        }
        PriceToSalesTrailing12Months rhs = ((PriceToSalesTrailing12Months) other);
