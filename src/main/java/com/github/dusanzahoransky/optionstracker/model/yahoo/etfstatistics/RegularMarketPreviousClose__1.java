...
public class RegularMarketPreviousClose__1 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose__1) == false) {
            return false;
        }
        RegularMarketPreviousClose__1 rhs = ((RegularMarketPreviousClose__1) other);
