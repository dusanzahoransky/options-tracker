...
public class OtherLiab__1 {
    ...
    public String toString() {
        ...
        sb.append(OtherLiab__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherLiab__1) == false) {
            return false;
        }
        OtherLiab__1 rhs = ((OtherLiab__1) other);
