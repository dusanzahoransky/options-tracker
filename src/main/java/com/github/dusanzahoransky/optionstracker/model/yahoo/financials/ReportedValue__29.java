...
public class ReportedValue__29 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__29.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__29) == false) {
            return false;
        }
        ReportedValue__29 rhs = ((ReportedValue__29) other);
