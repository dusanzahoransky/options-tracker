...
public class AccountsPayable__1 {
    ...
    public String toString() {
        ...
        sb.append(AccountsPayable__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccountsPayable__1) == false) {
            return false;
        }
        AccountsPayable__1 rhs = ((AccountsPayable__1) other);
