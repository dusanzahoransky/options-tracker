...
public class EndDate__3 {
    ...
    public String toString() {
        ...
        sb.append(EndDate__3.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EndDate__3) == false) {
            return false;
        }
        EndDate__3 rhs = ((EndDate__3) other);
