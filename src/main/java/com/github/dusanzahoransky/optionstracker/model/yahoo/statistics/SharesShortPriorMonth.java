...
public class SharesShortPriorMonth {
    ...
    public String toString() {
        ...
        sb.append(SharesShortPriorMonth.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SharesShortPriorMonth) == false) {
            return false;
        }
        SharesShortPriorMonth rhs = ((SharesShortPriorMonth) other);
