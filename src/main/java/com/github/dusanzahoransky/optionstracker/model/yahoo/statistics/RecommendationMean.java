...
public class RecommendationMean {
    ...
    public String toString() {
        ...
        sb.append(RecommendationMean.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecommendationMean) == false) {
            return false;
        }
        RecommendationMean rhs = ((RecommendationMean) other);
