...
public class EarningsHigh {
    ...
    public String toString() {
        ...
        sb.append(EarningsHigh.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarningsHigh) == false) {
            return false;
        }
        EarningsHigh rhs = ((EarningsHigh) other);
