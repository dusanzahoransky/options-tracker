...
public class AnnualNetIncome {
    ...
    private ReportedValue__26 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__26 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__26 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualNetIncome.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualNetIncome) == false) {
            return false;
        }
        AnnualNetIncome rhs = ((AnnualNetIncome) other);
