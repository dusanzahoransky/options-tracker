...
public class AnnualTotalAsset {
    ...
    public String toString() {
        ...
        sb.append(AnnualTotalAsset.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualTotalAsset) == false) {
            return false;
        }
        AnnualTotalAsset rhs = ((AnnualTotalAsset) other);
