...
public class StockPosition {
    ...
    public String toString() {
        ...
        sb.append(StockPosition.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StockPosition) == false) {
            return false;
        }
        StockPosition rhs = ((StockPosition) other);
