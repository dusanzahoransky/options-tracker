...
public class AnnualTotalLiabilitiesNetMinorityInterest {
    ...
    public String toString() {
        ...
        sb.append(AnnualTotalLiabilitiesNetMinorityInterest.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualTotalLiabilitiesNetMinorityInterest) == false) {
            return false;
        }
        AnnualTotalLiabilitiesNetMinorityInterest rhs = ((AnnualTotalLiabilitiesNetMinorityInterest) other);
