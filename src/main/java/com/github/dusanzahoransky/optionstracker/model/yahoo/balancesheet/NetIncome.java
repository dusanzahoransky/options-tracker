...
public class NetIncome {
    ...
    public String toString() {
        ...
        sb.append(NetIncome.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncome) == false) {
            return false;
        }
        NetIncome rhs = ((NetIncome) other);
