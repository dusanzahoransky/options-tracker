...
public class TenYear__1 {
    ...
    public String toString() {
        ...
        sb.append(TenYear__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TenYear__1) == false) {
            return false;
        }
        TenYear__1 rhs = ((TenYear__1) other);
