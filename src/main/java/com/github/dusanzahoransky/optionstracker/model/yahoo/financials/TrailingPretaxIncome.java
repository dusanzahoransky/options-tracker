...
public class TrailingPretaxIncome {
    ...
    private ReportedValue__13 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__13 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__13 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingPretaxIncome.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingPretaxIncome) == false) {
            return false;
        }
        TrailingPretaxIncome rhs = ((TrailingPretaxIncome) other);
