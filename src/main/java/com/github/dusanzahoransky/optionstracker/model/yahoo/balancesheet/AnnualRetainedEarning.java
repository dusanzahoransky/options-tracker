...
public class AnnualRetainedEarning {
    ...
    public String toString() {
        ...
        sb.append(AnnualRetainedEarning.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualRetainedEarning) == false) {
            return false;
        }
        AnnualRetainedEarning rhs = ((AnnualRetainedEarning) other);
