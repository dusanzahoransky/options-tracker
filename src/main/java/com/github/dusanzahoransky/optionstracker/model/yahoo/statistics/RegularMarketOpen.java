...
public class RegularMarketOpen {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketOpen.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketOpen) == false) {
            return false;
        }
        RegularMarketOpen rhs = ((RegularMarketOpen) other);
