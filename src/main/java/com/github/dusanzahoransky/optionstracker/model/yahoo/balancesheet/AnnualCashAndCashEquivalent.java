...
public class AnnualCashAndCashEquivalent {
    ...
    public String toString() {
        ...
        sb.append(AnnualCashAndCashEquivalent.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCashAndCashEquivalent) == false) {
            return false;
        }
        AnnualCashAndCashEquivalent rhs = ((AnnualCashAndCashEquivalent) other);
