...
public class AnnualTotalRevenue {
    ...
    private ReportedValue__22 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__22 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__22 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualTotalRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualTotalRevenue) == false) {
            return false;
        }
        AnnualTotalRevenue rhs = ((AnnualTotalRevenue) other);
