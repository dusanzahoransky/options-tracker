...
public class HeldPercentInstitutions {
    ...
    public String toString() {
        ...
        sb.append(HeldPercentInstitutions.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HeldPercentInstitutions) == false) {
            return false;
        }
        HeldPercentInstitutions rhs = ((HeldPercentInstitutions) other);
