...
public class ReportedValue__3 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__3.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__3) == false) {
            return false;
        }
        ReportedValue__3 rhs = ((ReportedValue__3) other);
