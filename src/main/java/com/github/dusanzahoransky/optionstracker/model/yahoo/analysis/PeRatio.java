...
public class PeRatio {
    ...
    public String toString() {
        ...
        sb.append(PeRatio.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PeRatio) == false) {
            return false;
        }
        PeRatio rhs = ((PeRatio) other);
