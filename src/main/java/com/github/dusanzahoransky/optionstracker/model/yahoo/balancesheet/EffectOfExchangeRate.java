...
public class EffectOfExchangeRate {
    ...
    public String toString() {
        ...
        sb.append(EffectOfExchangeRate.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EffectOfExchangeRate) == false) {
            return false;
        }
        EffectOfExchangeRate rhs = ((EffectOfExchangeRate) other);
