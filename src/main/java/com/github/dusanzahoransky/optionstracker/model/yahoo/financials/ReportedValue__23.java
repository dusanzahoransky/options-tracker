...
public class ReportedValue__23 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__23.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__23) == false) {
            return false;
        }
        ReportedValue__23 rhs = ((ReportedValue__23) other);
