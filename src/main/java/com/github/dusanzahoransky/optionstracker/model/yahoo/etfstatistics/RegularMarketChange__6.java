...
public class RegularMarketChange__6 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChange__6 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChange__6) == false) {
            return false;
        }
        RegularMarketChange__6 rhs = ((RegularMarketChange__6) other);
