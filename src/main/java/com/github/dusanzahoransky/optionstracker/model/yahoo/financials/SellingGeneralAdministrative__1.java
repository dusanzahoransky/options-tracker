...
public class SellingGeneralAdministrative__1 {
    ...
    public String toString() {
        ...
        sb.append(SellingGeneralAdministrative__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SellingGeneralAdministrative__1) == false) {
            return false;
        }
        SellingGeneralAdministrative__1 rhs = ((SellingGeneralAdministrative__1) other);
