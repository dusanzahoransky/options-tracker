...
public class PriceHint__1 {
    ...
    public String toString() {
        ...
        sb.append(PriceHint__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriceHint__1) == false) {
            return false;
        }
        PriceHint__1 rhs = ((PriceHint__1) other);
