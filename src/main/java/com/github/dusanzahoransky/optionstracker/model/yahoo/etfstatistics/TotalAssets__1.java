...
public class TotalAssets__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalAssets__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalAssets__1) == false) {
            return false;
        }
        TotalAssets__1 rhs = ((TotalAssets__1) other);
