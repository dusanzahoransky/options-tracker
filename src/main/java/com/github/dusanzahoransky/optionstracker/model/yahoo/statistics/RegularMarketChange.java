...
public class RegularMarketChange {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChange.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChange) == false) {
            return false;
        }
        RegularMarketChange rhs = ((RegularMarketChange) other);
