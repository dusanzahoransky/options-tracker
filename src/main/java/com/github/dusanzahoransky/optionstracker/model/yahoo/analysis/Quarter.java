...
public class Quarter {
    ...
    public String toString() {
        ...
        sb.append(Quarter.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Quarter) == false) {
            return false;
        }
        Quarter rhs = ((Quarter) other);
