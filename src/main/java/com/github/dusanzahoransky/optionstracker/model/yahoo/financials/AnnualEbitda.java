...
public class AnnualEbitda {
    ...
    private ReportedValue__19 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__19 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__19 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualEbitda.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualEbitda) == false) {
            return false;
        }
        AnnualEbitda rhs = ((AnnualEbitda) other);
