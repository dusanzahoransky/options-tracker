...
public class Growth__3 {
    ...
    public String toString() {
        ...
        sb.append(Growth__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Growth__3) == false) {
            return false;
        }
        Growth__3 rhs = ((Growth__3) other);
