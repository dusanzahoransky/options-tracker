...
public class _30daysAgo {
    ...
    public String toString() {
        ...
        sb.append(_30daysAgo.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _30daysAgo) == false) {
            return false;
        }
        _30daysAgo rhs = ((_30daysAgo) other);
