...
public class ConsumerCyclical {
    ...
    public String toString() {
        ...
        sb.append(ConsumerCyclical.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConsumerCyclical) == false) {
            return false;
        }
        ConsumerCyclical rhs = ((ConsumerCyclical) other);
