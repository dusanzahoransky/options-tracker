...
public class FiftyTwoWeekLowChangePercent__1 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChangePercent__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChangePercent__1) == false) {
            return false;
        }
        FiftyTwoWeekLowChangePercent__1 rhs = ((FiftyTwoWeekLowChangePercent__1) other);
