...
public class GrossProfit {
    ...
    public String toString() {
        ...
        sb.append(GrossProfit.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GrossProfit) == false) {
            return false;
        }
        GrossProfit rhs = ((GrossProfit) other);
