...
public class TotalCashFromFinancingActivities {
    ...
    public String toString() {
        ...
        sb.append(TotalCashFromFinancingActivities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCashFromFinancingActivities) == false) {
            return false;
        }
        TotalCashFromFinancingActivities rhs = ((TotalCashFromFinancingActivities) other);
