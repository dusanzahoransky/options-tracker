...
public class TotalCashPerShare {
    ...
    public String toString() {
        ...
        sb.append(TotalCashPerShare.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCashPerShare) == false) {
            return false;
        }
        TotalCashPerShare rhs = ((TotalCashPerShare) other);
