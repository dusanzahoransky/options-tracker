...
public class Depreciation__1 {
    ...
    public String toString() {
        ...
        sb.append(Depreciation__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Depreciation__1) == false) {
            return false;
        }
        Depreciation__1 rhs = ((Depreciation__1) other);
