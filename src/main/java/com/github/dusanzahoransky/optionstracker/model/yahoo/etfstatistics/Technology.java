...
public class Technology {
    ...
    public String toString() {
        ...
        sb.append(Technology.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Technology) == false) {
            return false;
        }
        Technology rhs = ((Technology) other);
