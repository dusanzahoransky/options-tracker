...
public class FiftyTwoWeekLowChangePercent {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChangePercent.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChangePercent) == false) {
            return false;
        }
        FiftyTwoWeekLowChangePercent rhs = ((FiftyTwoWeekLowChangePercent) other);
