...
public class RepurchaseOfStock {
    ...
    public String toString() {
        ...
        sb.append(RepurchaseOfStock.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RepurchaseOfStock) == false) {
            return false;
        }
        RepurchaseOfStock rhs = ((RepurchaseOfStock) other);
