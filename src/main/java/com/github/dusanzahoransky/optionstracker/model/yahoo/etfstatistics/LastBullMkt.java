...
public class LastBullMkt {
    ...
    public String toString() {
        ...
        sb.append(LastBullMkt.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LastBullMkt) == false) {
            return false;
        }
        LastBullMkt rhs = ((LastBullMkt) other);
