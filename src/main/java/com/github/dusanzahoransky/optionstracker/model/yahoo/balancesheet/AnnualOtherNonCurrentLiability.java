...
public class AnnualOtherNonCurrentLiability {
    ...
    public String toString() {
        ...
        sb.append(AnnualOtherNonCurrentLiability.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualOtherNonCurrentLiability) == false) {
            return false;
        }
        AnnualOtherNonCurrentLiability rhs = ((AnnualOtherNonCurrentLiability) other);
