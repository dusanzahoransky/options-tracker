...
public class ReportedValue__31 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__31.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__31) == false) {
            return false;
        }
        ReportedValue__31 rhs = ((ReportedValue__31) other);
