...
public class RegularMarketChangePercent__4 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChangePercent__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChangePercent__4) == false) {
            return false;
        }
        RegularMarketChangePercent__4 rhs = ((RegularMarketChangePercent__4) other);
