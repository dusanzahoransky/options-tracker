...
public class FiftyTwoWeekLowChange__4 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChange__4 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChange__4) == false) {
            return false;
        }
        FiftyTwoWeekLowChange__4 rhs = ((FiftyTwoWeekLowChange__4) other);
