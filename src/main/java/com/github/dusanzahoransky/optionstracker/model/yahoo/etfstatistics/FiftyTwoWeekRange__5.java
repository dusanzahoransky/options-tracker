...
public class FiftyTwoWeekRange__5 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekRange__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekRange__5) == false) {
            return false;
        }
        FiftyTwoWeekRange__5 rhs = ((FiftyTwoWeekRange__5) other);
