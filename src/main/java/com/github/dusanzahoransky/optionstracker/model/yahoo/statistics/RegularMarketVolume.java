...
public class RegularMarketVolume {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketVolume.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketVolume) == false) {
            return false;
        }
        RegularMarketVolume rhs = ((RegularMarketVolume) other);
