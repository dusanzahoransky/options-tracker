...
public class OtherCurrentAssets {
    ...
    public String toString() {
        ...
        sb.append(OtherCurrentAssets.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCurrentAssets) == false) {
            return false;
        }
        OtherCurrentAssets rhs = ((OtherCurrentAssets) other);
