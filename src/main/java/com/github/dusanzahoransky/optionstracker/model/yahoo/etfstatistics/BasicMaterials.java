...
public class BasicMaterials {
    ...
    public String toString() {
        ...
        sb.append(BasicMaterials.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BasicMaterials) == false) {
            return false;
        }
        BasicMaterials rhs = ((BasicMaterials) other);
