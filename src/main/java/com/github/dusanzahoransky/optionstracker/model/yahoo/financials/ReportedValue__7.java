...
public class ReportedValue__7 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__7.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__7) == false) {
            return false;
        }
        ReportedValue__7 rhs = ((ReportedValue__7) other);
