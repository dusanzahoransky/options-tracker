...
public class TotalStockholderEquity {
    ...
    public String toString() {
        ...
        sb.append(TotalStockholderEquity.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalStockholderEquity) == false) {
            return false;
        }
        TotalStockholderEquity rhs = ((TotalStockholderEquity) other);
