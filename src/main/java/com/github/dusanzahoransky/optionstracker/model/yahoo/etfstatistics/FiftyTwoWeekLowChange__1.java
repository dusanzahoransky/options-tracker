...
public class FiftyTwoWeekLowChange__1 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChange__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChange__1) == false) {
            return false;
        }
        FiftyTwoWeekLowChange__1 rhs = ((FiftyTwoWeekLowChange__1) other);
