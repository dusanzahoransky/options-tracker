...
public class VmidL {
    ...
    private RegularMarketOpen__4 regularMarketOpen;
    @JsonProperty("exchange")
    private String exchange;
    @JsonProperty("regularMarketTime")
    private RegularMarketTime__2 regularMarketTime;
    @JsonProperty("fiftyTwoWeekRange")
    private FiftyTwoWeekRange__2 fiftyTwoWeekRange;
    @JsonProperty("regularMarketDayHigh")
    private RegularMarketDayHigh__4 regularMarketDayHigh;
    ...
    private RegularMarketChange__3 regularMarketChange;
    @JsonProperty("regularMarketPreviousClose")
    private RegularMarketPreviousClose__4 regularMarketPreviousClose;
    @JsonProperty("fiftyTwoWeekHighChange")
    private FiftyTwoWeekHighChange__2 fiftyTwoWeekHighChange;
    @JsonProperty("exchangeTimezoneShortName")
    private String exchangeTimezoneShortName;
    @JsonProperty("fiftyTwoWeekLowChange")
    private FiftyTwoWeekLowChange__2 fiftyTwoWeekLowChange;
    @JsonProperty("exchangeDataDelayedBy")
    private Long exchangeDataDelayedBy;
    @JsonProperty("regularMarketDayLow")
    private RegularMarketDayLow__4 regularMarketDayLow;
    @JsonProperty("priceHint")
    private Long priceHint;
    @JsonProperty("currency")
    private String currency;
    @JsonProperty("regularMarketPrice")
    private RegularMarketPrice__3 regularMarketPrice;
    @JsonProperty("regularMarketVolume")
    private RegularMarketVolume__4 regularMarketVolume;
    ...
    private FiftyTwoWeekLowChangePercent__2 fiftyTwoWeekLowChangePercent;
    @JsonProperty("regularMarketDayRange")
    private RegularMarketDayRange__2 regularMarketDayRange;
    @JsonProperty("messageBoardId")
    private String messageBoardId;
    @JsonProperty("fiftyTwoWeekHigh")
    private FiftyTwoWeekHigh__3 fiftyTwoWeekHigh;
    @JsonProperty("fiftyTwoWeekHighChangePercent")
    private FiftyTwoWeekHighChangePercent__2 fiftyTwoWeekHighChangePercent;
    @JsonProperty("uuid")
    private String uuid;
    @JsonProperty("market")
    private String market;
    @JsonProperty("fiftyTwoWeekLow")
    private FiftyTwoWeekLow__3 fiftyTwoWeekLow;
    @JsonProperty("regularMarketChangePercent")
    private RegularMarketChangePercent__3 regularMarketChangePercent;
    ...
    @JsonProperty("regularMarketOpen")
    public RegularMarketOpen__4 getRegularMarketOpen() {
        return regularMarketOpen;
    }

    @JsonProperty("regularMarketOpen")
    public void setRegularMarketOpen(RegularMarketOpen__4 regularMarketOpen) {
    ...
    @JsonProperty("regularMarketTime")
    public RegularMarketTime__2 getRegularMarketTime() {
        return regularMarketTime;
    }

    @JsonProperty("regularMarketTime")
    public void setRegularMarketTime(RegularMarketTime__2 regularMarketTime) {
        this.regularMarketTime = regularMarketTime;
    }

    @JsonProperty("fiftyTwoWeekRange")
    public FiftyTwoWeekRange__2 getFiftyTwoWeekRange() {
        return fiftyTwoWeekRange;
    }

    @JsonProperty("fiftyTwoWeekRange")
    public void setFiftyTwoWeekRange(FiftyTwoWeekRange__2 fiftyTwoWeekRange) {
        this.fiftyTwoWeekRange = fiftyTwoWeekRange;
    }

    @JsonProperty("regularMarketDayHigh")
    public RegularMarketDayHigh__4 getRegularMarketDayHigh() {
        return regularMarketDayHigh;
    }

    @JsonProperty("regularMarketDayHigh")
    public void setRegularMarketDayHigh(RegularMarketDayHigh__4 regularMarketDayHigh) {
    ...
    @JsonProperty("regularMarketChange")
    public RegularMarketChange__3 getRegularMarketChange() {
        return regularMarketChange;
    }

    @JsonProperty("regularMarketChange")
    public void setRegularMarketChange(RegularMarketChange__3 regularMarketChange) {
        this.regularMarketChange = regularMarketChange;
    }

    @JsonProperty("regularMarketPreviousClose")
    public RegularMarketPreviousClose__4 getRegularMarketPreviousClose() {
        return regularMarketPreviousClose;
    }

    @JsonProperty("regularMarketPreviousClose")
    public void setRegularMarketPreviousClose(RegularMarketPreviousClose__4 regularMarketPreviousClose) {
        this.regularMarketPreviousClose = regularMarketPreviousClose;
    }

    @JsonProperty("fiftyTwoWeekHighChange")
    public FiftyTwoWeekHighChange__2 getFiftyTwoWeekHighChange() {
        return fiftyTwoWeekHighChange;
    }

    @JsonProperty("fiftyTwoWeekHighChange")
    public void setFiftyTwoWeekHighChange(FiftyTwoWeekHighChange__2 fiftyTwoWeekHighChange) {
    ...
    @JsonProperty("fiftyTwoWeekLowChange")
    public FiftyTwoWeekLowChange__2 getFiftyTwoWeekLowChange() {
        return fiftyTwoWeekLowChange;
    }

    @JsonProperty("fiftyTwoWeekLowChange")
    public void setFiftyTwoWeekLowChange(FiftyTwoWeekLowChange__2 fiftyTwoWeekLowChange) {
    ...
    @JsonProperty("regularMarketDayLow")
    public RegularMarketDayLow__4 getRegularMarketDayLow() {
        return regularMarketDayLow;
    }

    @JsonProperty("regularMarketDayLow")
    public void setRegularMarketDayLow(RegularMarketDayLow__4 regularMarketDayLow) {
    ...
    @JsonProperty("regularMarketPrice")
    public RegularMarketPrice__3 getRegularMarketPrice() {
        return regularMarketPrice;
    }

    @JsonProperty("regularMarketPrice")
    public void setRegularMarketPrice(RegularMarketPrice__3 regularMarketPrice) {
        this.regularMarketPrice = regularMarketPrice;
    }

    @JsonProperty("regularMarketVolume")
    public RegularMarketVolume__4 getRegularMarketVolume() {
        return regularMarketVolume;
    }

    @JsonProperty("regularMarketVolume")
    public void setRegularMarketVolume(RegularMarketVolume__4 regularMarketVolume) {
    ...
    @JsonProperty("fiftyTwoWeekLowChangePercent")
    public FiftyTwoWeekLowChangePercent__2 getFiftyTwoWeekLowChangePercent() {
        return fiftyTwoWeekLowChangePercent;
    }

    @JsonProperty("fiftyTwoWeekLowChangePercent")
    public void setFiftyTwoWeekLowChangePercent(FiftyTwoWeekLowChangePercent__2 fiftyTwoWeekLowChangePercent) {
        this.fiftyTwoWeekLowChangePercent = fiftyTwoWeekLowChangePercent;
    }

    @JsonProperty("regularMarketDayRange")
    public RegularMarketDayRange__2 getRegularMarketDayRange() {
        return regularMarketDayRange;
    }

    @JsonProperty("regularMarketDayRange")
    public void setRegularMarketDayRange(RegularMarketDayRange__2 regularMarketDayRange) {
    ...
    @JsonProperty("fiftyTwoWeekHigh")
    public FiftyTwoWeekHigh__3 getFiftyTwoWeekHigh() {
        return fiftyTwoWeekHigh;
    }

    @JsonProperty("fiftyTwoWeekHigh")
    public void setFiftyTwoWeekHigh(FiftyTwoWeekHigh__3 fiftyTwoWeekHigh) {
        this.fiftyTwoWeekHigh = fiftyTwoWeekHigh;
    }

    @JsonProperty("fiftyTwoWeekHighChangePercent")
    public FiftyTwoWeekHighChangePercent__2 getFiftyTwoWeekHighChangePercent() {
        return fiftyTwoWeekHighChangePercent;
    }

    @JsonProperty("fiftyTwoWeekHighChangePercent")
    public void setFiftyTwoWeekHighChangePercent(FiftyTwoWeekHighChangePercent__2 fiftyTwoWeekHighChangePercent) {
    ...
    @JsonProperty("fiftyTwoWeekLow")
    public FiftyTwoWeekLow__3 getFiftyTwoWeekLow() {
        return fiftyTwoWeekLow;
    }

    @JsonProperty("fiftyTwoWeekLow")
    public void setFiftyTwoWeekLow(FiftyTwoWeekLow__3 fiftyTwoWeekLow) {
        this.fiftyTwoWeekLow = fiftyTwoWeekLow;
    }

    @JsonProperty("regularMarketChangePercent")
    public RegularMarketChangePercent__3 getRegularMarketChangePercent() {
        return regularMarketChangePercent;
    }

    @JsonProperty("regularMarketChangePercent")
    public void setRegularMarketChangePercent(RegularMarketChangePercent__3 regularMarketChangePercent) {
    ...
    public String toString() {
        ...
        sb.append(VmidL.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VmidL) == false) {
            return false;
        }
        VmidL rhs = ((VmidL) other);
