...
public class ShortTermInvestments {
    ...
    public String toString() {
        ...
        sb.append(ShortTermInvestments.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ShortTermInvestments) == false) {
            return false;
        }
        ShortTermInvestments rhs = ((ShortTermInvestments) other);
