...
public class TrailingOtherIncomeExpense {
    ...
    private ReportedValue__28 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__28 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__28 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingOtherIncomeExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingOtherIncomeExpense) == false) {
            return false;
        }
        TrailingOtherIncomeExpense rhs = ((TrailingOtherIncomeExpense) other);
