...
public class ThreeYearTotalReturn {
    ...
    public String toString() {
        ...
        sb.append(ThreeYearTotalReturn.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThreeYearTotalReturn) == false) {
            return false;
        }
        ThreeYearTotalReturn rhs = ((ThreeYearTotalReturn) other);
