...
public class AverageDailyVolume10Day {
    ...
    public String toString() {
        ...
        sb.append(AverageDailyVolume10Day.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AverageDailyVolume10Day) == false) {
            return false;
        }
        AverageDailyVolume10Day rhs = ((AverageDailyVolume10Day) other);
