...
public class AnnualCostOfRevenue {
    ...
    private ReportedValue__21 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__21 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__21 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualCostOfRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualCostOfRevenue) == false) {
            return false;
        }
        AnnualCostOfRevenue rhs = ((AnnualCostOfRevenue) other);
