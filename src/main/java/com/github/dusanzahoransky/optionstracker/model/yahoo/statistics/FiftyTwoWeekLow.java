...
public class FiftyTwoWeekLow {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLow.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLow) == false) {
            return false;
        }
        FiftyTwoWeekLow rhs = ((FiftyTwoWeekLow) other);
