...
public class IncomeStatementHistory__1 {

    @JsonProperty("incomeStatementHistory")
    private List<IncomeStatementHistory__2> incomeStatementHistory = new ArrayList<IncomeStatementHistory__2>();
    @JsonProperty("maxAge")
    private Long maxAge;
    @JsonIgnore
    ...
    @JsonProperty("incomeStatementHistory")
    public List<IncomeStatementHistory__2> getIncomeStatementHistory() {
        return incomeStatementHistory;
    }

    @JsonProperty("incomeStatementHistory")
    public void setIncomeStatementHistory(List<IncomeStatementHistory__2> incomeStatementHistory) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IncomeStatementHistory__1) == false) {
            return false;
        }
