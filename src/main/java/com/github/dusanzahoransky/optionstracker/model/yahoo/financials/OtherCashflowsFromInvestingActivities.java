...
public class OtherCashflowsFromInvestingActivities {
    ...
    public String toString() {
        ...
        sb.append(OtherCashflowsFromInvestingActivities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCashflowsFromInvestingActivities) == false) {
            return false;
        }
        OtherCashflowsFromInvestingActivities rhs = ((OtherCashflowsFromInvestingActivities) other);
