...
public class TargetMedianPrice {
    ...
    public String toString() {
        ...
        sb.append(TargetMedianPrice.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TargetMedianPrice) == false) {
            return false;
        }
        TargetMedianPrice rhs = ((TargetMedianPrice) other);
