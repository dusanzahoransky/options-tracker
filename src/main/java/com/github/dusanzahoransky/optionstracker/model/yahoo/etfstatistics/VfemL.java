...
public class VfemL {
    ...
    private RegularMarketOpen__5 regularMarketOpen;
    @JsonProperty("exchange")
    private String exchange;
    @JsonProperty("regularMarketTime")
    private RegularMarketTime__3 regularMarketTime;
    @JsonProperty("fiftyTwoWeekRange")
    private FiftyTwoWeekRange__3 fiftyTwoWeekRange;
    @JsonProperty("regularMarketDayHigh")
    private RegularMarketDayHigh__5 regularMarketDayHigh;
    ...
    private RegularMarketChange__4 regularMarketChange;
    @JsonProperty("regularMarketPreviousClose")
    private RegularMarketPreviousClose__5 regularMarketPreviousClose;
    @JsonProperty("fiftyTwoWeekHighChange")
    private FiftyTwoWeekHighChange__3 fiftyTwoWeekHighChange;
    @JsonProperty("exchangeTimezoneShortName")
    private String exchangeTimezoneShortName;
    @JsonProperty("fiftyTwoWeekLowChange")
    private FiftyTwoWeekLowChange__3 fiftyTwoWeekLowChange;
    @JsonProperty("exchangeDataDelayedBy")
    private Long exchangeDataDelayedBy;
    @JsonProperty("regularMarketDayLow")
    private RegularMarketDayLow__5 regularMarketDayLow;
    @JsonProperty("priceHint")
    private Long priceHint;
    @JsonProperty("currency")
    private String currency;
    @JsonProperty("regularMarketPrice")
    private RegularMarketPrice__4 regularMarketPrice;
    @JsonProperty("regularMarketVolume")
    private RegularMarketVolume__5 regularMarketVolume;
    ...
    private FiftyTwoWeekLowChangePercent__3 fiftyTwoWeekLowChangePercent;
    @JsonProperty("regularMarketDayRange")
    private RegularMarketDayRange__3 regularMarketDayRange;
    @JsonProperty("messageBoardId")
    private String messageBoardId;
    @JsonProperty("fiftyTwoWeekHigh")
    private FiftyTwoWeekHigh__4 fiftyTwoWeekHigh;
    @JsonProperty("fiftyTwoWeekHighChangePercent")
    private FiftyTwoWeekHighChangePercent__3 fiftyTwoWeekHighChangePercent;
    @JsonProperty("uuid")
    private String uuid;
    @JsonProperty("market")
    private String market;
    @JsonProperty("fiftyTwoWeekLow")
    private FiftyTwoWeekLow__4 fiftyTwoWeekLow;
    @JsonProperty("regularMarketChangePercent")
    private RegularMarketChangePercent__4 regularMarketChangePercent;
    ...
    @JsonProperty("regularMarketOpen")
    public RegularMarketOpen__5 getRegularMarketOpen() {
        return regularMarketOpen;
    }

    @JsonProperty("regularMarketOpen")
    public void setRegularMarketOpen(RegularMarketOpen__5 regularMarketOpen) {
    ...
    @JsonProperty("regularMarketTime")
    public RegularMarketTime__3 getRegularMarketTime() {
        return regularMarketTime;
    }

    @JsonProperty("regularMarketTime")
    public void setRegularMarketTime(RegularMarketTime__3 regularMarketTime) {
        this.regularMarketTime = regularMarketTime;
    }

    @JsonProperty("fiftyTwoWeekRange")
    public FiftyTwoWeekRange__3 getFiftyTwoWeekRange() {
        return fiftyTwoWeekRange;
    }

    @JsonProperty("fiftyTwoWeekRange")
    public void setFiftyTwoWeekRange(FiftyTwoWeekRange__3 fiftyTwoWeekRange) {
        this.fiftyTwoWeekRange = fiftyTwoWeekRange;
    }

    @JsonProperty("regularMarketDayHigh")
    public RegularMarketDayHigh__5 getRegularMarketDayHigh() {
        return regularMarketDayHigh;
    }

    @JsonProperty("regularMarketDayHigh")
    public void setRegularMarketDayHigh(RegularMarketDayHigh__5 regularMarketDayHigh) {
    ...
    @JsonProperty("regularMarketChange")
    public RegularMarketChange__4 getRegularMarketChange() {
        return regularMarketChange;
    }

    @JsonProperty("regularMarketChange")
    public void setRegularMarketChange(RegularMarketChange__4 regularMarketChange) {
        this.regularMarketChange = regularMarketChange;
    }

    @JsonProperty("regularMarketPreviousClose")
    public RegularMarketPreviousClose__5 getRegularMarketPreviousClose() {
        return regularMarketPreviousClose;
    }

    @JsonProperty("regularMarketPreviousClose")
    public void setRegularMarketPreviousClose(RegularMarketPreviousClose__5 regularMarketPreviousClose) {
        this.regularMarketPreviousClose = regularMarketPreviousClose;
    }

    @JsonProperty("fiftyTwoWeekHighChange")
    public FiftyTwoWeekHighChange__3 getFiftyTwoWeekHighChange() {
        return fiftyTwoWeekHighChange;
    }

    @JsonProperty("fiftyTwoWeekHighChange")
    public void setFiftyTwoWeekHighChange(FiftyTwoWeekHighChange__3 fiftyTwoWeekHighChange) {
    ...
    @JsonProperty("fiftyTwoWeekLowChange")
    public FiftyTwoWeekLowChange__3 getFiftyTwoWeekLowChange() {
        return fiftyTwoWeekLowChange;
    }

    @JsonProperty("fiftyTwoWeekLowChange")
    public void setFiftyTwoWeekLowChange(FiftyTwoWeekLowChange__3 fiftyTwoWeekLowChange) {
    ...
    @JsonProperty("regularMarketDayLow")
    public RegularMarketDayLow__5 getRegularMarketDayLow() {
        return regularMarketDayLow;
    }

    @JsonProperty("regularMarketDayLow")
    public void setRegularMarketDayLow(RegularMarketDayLow__5 regularMarketDayLow) {
    ...
    @JsonProperty("regularMarketPrice")
    public RegularMarketPrice__4 getRegularMarketPrice() {
        return regularMarketPrice;
    }

    @JsonProperty("regularMarketPrice")
    public void setRegularMarketPrice(RegularMarketPrice__4 regularMarketPrice) {
        this.regularMarketPrice = regularMarketPrice;
    }

    @JsonProperty("regularMarketVolume")
    public RegularMarketVolume__5 getRegularMarketVolume() {
        return regularMarketVolume;
    }

    @JsonProperty("regularMarketVolume")
    public void setRegularMarketVolume(RegularMarketVolume__5 regularMarketVolume) {
    ...
    @JsonProperty("fiftyTwoWeekLowChangePercent")
    public FiftyTwoWeekLowChangePercent__3 getFiftyTwoWeekLowChangePercent() {
        return fiftyTwoWeekLowChangePercent;
    }

    @JsonProperty("fiftyTwoWeekLowChangePercent")
    public void setFiftyTwoWeekLowChangePercent(FiftyTwoWeekLowChangePercent__3 fiftyTwoWeekLowChangePercent) {
        this.fiftyTwoWeekLowChangePercent = fiftyTwoWeekLowChangePercent;
    }

    @JsonProperty("regularMarketDayRange")
    public RegularMarketDayRange__3 getRegularMarketDayRange() {
        return regularMarketDayRange;
    }

    @JsonProperty("regularMarketDayRange")
    public void setRegularMarketDayRange(RegularMarketDayRange__3 regularMarketDayRange) {
    ...
    @JsonProperty("fiftyTwoWeekHigh")
    public FiftyTwoWeekHigh__4 getFiftyTwoWeekHigh() {
        return fiftyTwoWeekHigh;
    }

    @JsonProperty("fiftyTwoWeekHigh")
    public void setFiftyTwoWeekHigh(FiftyTwoWeekHigh__4 fiftyTwoWeekHigh) {
        this.fiftyTwoWeekHigh = fiftyTwoWeekHigh;
    }

    @JsonProperty("fiftyTwoWeekHighChangePercent")
    public FiftyTwoWeekHighChangePercent__3 getFiftyTwoWeekHighChangePercent() {
        return fiftyTwoWeekHighChangePercent;
    }

    @JsonProperty("fiftyTwoWeekHighChangePercent")
    public void setFiftyTwoWeekHighChangePercent(FiftyTwoWeekHighChangePercent__3 fiftyTwoWeekHighChangePercent) {
    ...
    @JsonProperty("fiftyTwoWeekLow")
    public FiftyTwoWeekLow__4 getFiftyTwoWeekLow() {
        return fiftyTwoWeekLow;
    }

    @JsonProperty("fiftyTwoWeekLow")
    public void setFiftyTwoWeekLow(FiftyTwoWeekLow__4 fiftyTwoWeekLow) {
        this.fiftyTwoWeekLow = fiftyTwoWeekLow;
    }

    @JsonProperty("regularMarketChangePercent")
    public RegularMarketChangePercent__4 getRegularMarketChangePercent() {
        return regularMarketChangePercent;
    }

    @JsonProperty("regularMarketChangePercent")
    public void setRegularMarketChangePercent(RegularMarketChangePercent__4 regularMarketChangePercent) {
    ...
    public String toString() {
        ...
        sb.append(VfemL.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VfemL) == false) {
            return false;
        }
        VfemL rhs = ((VfemL) other);
