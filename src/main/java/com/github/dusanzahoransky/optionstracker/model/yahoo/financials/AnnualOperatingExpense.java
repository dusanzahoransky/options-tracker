...
public class AnnualOperatingExpense {
    ...
    private ReportedValue__4 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__4 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__4 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualOperatingExpense.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualOperatingExpense) == false) {
            return false;
        }
        AnnualOperatingExpense rhs = ((AnnualOperatingExpense) other);
