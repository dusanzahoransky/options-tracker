...
public class RegularMarketChangePercent__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketChangePercent__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketChangePercent__2) == false) {
            return false;
        }
        RegularMarketChangePercent__2 rhs = ((RegularMarketChangePercent__2) other);
