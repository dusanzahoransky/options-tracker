...
public class Investments__1 {
    ...
    public String toString() {
        ...
        sb.append(Investments__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Investments__1) == false) {
            return false;
        }
        Investments__1 rhs = ((Investments__1) other);
