...
public class ChangeInCash__1 {
    ...
    public String toString() {
        ...
        sb.append(ChangeInCash__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangeInCash__1) == false) {
            return false;
        }
        ChangeInCash__1 rhs = ((ChangeInCash__1) other);
