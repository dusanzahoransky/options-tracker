...
public class SharesPercentSharesOut {
    ...
    public String toString() {
        ...
        sb.append(SharesPercentSharesOut.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SharesPercentSharesOut) == false) {
            return false;
        }
        SharesPercentSharesOut rhs = ((SharesPercentSharesOut) other);
