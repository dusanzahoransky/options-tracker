...
public class TreasuryStock__1 {
    ...
    public String toString() {
        ...
        sb.append(TreasuryStock__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TreasuryStock__1) == false) {
            return false;
        }
        TreasuryStock__1 rhs = ((TreasuryStock__1) other);
