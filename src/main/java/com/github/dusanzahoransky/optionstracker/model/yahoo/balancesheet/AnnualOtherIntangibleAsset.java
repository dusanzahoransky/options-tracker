...
public class AnnualOtherIntangibleAsset {
    ...
    public String toString() {
        ...
        sb.append(AnnualOtherIntangibleAsset.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualOtherIntangibleAsset) == false) {
            return false;
        }
        AnnualOtherIntangibleAsset rhs = ((AnnualOtherIntangibleAsset) other);
