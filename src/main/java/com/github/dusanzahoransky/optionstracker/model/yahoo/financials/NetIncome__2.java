...
public class NetIncome__2 {
    ...
    public String toString() {
        ...
        sb.append(NetIncome__2.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncome__2) == false) {
            return false;
        }
        NetIncome__2 rhs = ((NetIncome__2) other);
