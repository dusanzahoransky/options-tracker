...
public class TotalDebt {
    ...
    public String toString() {
        ...
        sb.append(TotalDebt.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalDebt) == false) {
            return false;
        }
        TotalDebt rhs = ((TotalDebt) other);
