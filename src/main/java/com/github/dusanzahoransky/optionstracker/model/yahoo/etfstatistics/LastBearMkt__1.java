...
public class LastBearMkt__1 {
    ...
    public String toString() {
        ...
        sb.append(LastBearMkt__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LastBearMkt__1) == false) {
            return false;
        }
        LastBearMkt__1 rhs = ((LastBearMkt__1) other);
