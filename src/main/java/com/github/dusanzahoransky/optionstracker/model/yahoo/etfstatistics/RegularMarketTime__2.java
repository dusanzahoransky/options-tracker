...
public class RegularMarketTime__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketTime__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketTime__2) == false) {
            return false;
        }
        RegularMarketTime__2 rhs = ((RegularMarketTime__2) other);
