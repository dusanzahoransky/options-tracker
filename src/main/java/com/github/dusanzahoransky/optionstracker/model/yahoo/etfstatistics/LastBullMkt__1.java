...
public class LastBullMkt__1 {
    ...
    public String toString() {
        ...
        sb.append(LastBullMkt__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LastBullMkt__1) == false) {
            return false;
        }
        LastBullMkt__1 rhs = ((LastBullMkt__1) other);
