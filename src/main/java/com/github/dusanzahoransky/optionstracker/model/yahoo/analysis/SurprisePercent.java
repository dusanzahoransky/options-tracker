...
public class SurprisePercent {
    ...
    public String toString() {
        ...
        sb.append(SurprisePercent.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SurprisePercent) == false) {
            return false;
        }
        SurprisePercent rhs = ((SurprisePercent) other);
