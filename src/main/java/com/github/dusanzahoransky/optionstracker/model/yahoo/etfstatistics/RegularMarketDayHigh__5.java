...
public class RegularMarketDayHigh__5 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayHigh__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayHigh__5) == false) {
            return false;
        }
        RegularMarketDayHigh__5 rhs = ((RegularMarketDayHigh__5) other);
