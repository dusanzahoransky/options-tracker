...
public class FiftyTwoWeekLowChangePercent__5 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekLowChangePercent__5 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekLowChangePercent__5) == false) {
            return false;
        }
        FiftyTwoWeekLowChangePercent__5 rhs = ((FiftyTwoWeekLowChangePercent__5) other);
