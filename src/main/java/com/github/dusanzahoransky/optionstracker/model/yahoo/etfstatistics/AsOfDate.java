...
public class AsOfDate {
    ...
    public String toString() {
        ...
        sb.append(AsOfDate.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AsOfDate) == false) {
            return false;
        }
        AsOfDate rhs = ((AsOfDate) other);
