...
public class AnnualStockholdersEquity {
    ...
    public String toString() {
        ...
        sb.append(AnnualStockholdersEquity.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualStockholdersEquity) == false) {
            return false;
        }
        AnnualStockholdersEquity rhs = ((AnnualStockholdersEquity) other);
