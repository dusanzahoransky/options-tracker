...
public class ReportedValue__26 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__26.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__26) == false) {
            return false;
        }
        ReportedValue__26 rhs = ((ReportedValue__26) other);
