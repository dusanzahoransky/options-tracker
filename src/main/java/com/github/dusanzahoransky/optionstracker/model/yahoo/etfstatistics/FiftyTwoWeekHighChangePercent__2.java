...
public class FiftyTwoWeekHighChangePercent__2 {
    ...
    public String toString() {
        ...
        sb.append(FiftyTwoWeekHighChangePercent__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FiftyTwoWeekHighChangePercent__2) == false) {
            return false;
        }
        FiftyTwoWeekHighChangePercent__2 rhs = ((FiftyTwoWeekHighChangePercent__2) other);
