...
public class TotalCash {
    ...
    public String toString() {
        ...
        sb.append(TotalCash.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCash) == false) {
            return false;
        }
        TotalCash rhs = ((TotalCash) other);
