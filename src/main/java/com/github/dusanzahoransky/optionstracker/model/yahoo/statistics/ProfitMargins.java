...
public class ProfitMargins {
    ...
    public String toString() {
        ...
        sb.append(ProfitMargins.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProfitMargins) == false) {
            return false;
        }
        ProfitMargins rhs = ((ProfitMargins) other);
