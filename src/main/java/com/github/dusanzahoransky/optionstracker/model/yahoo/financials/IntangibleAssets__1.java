...
public class IntangibleAssets__1 {
    ...
    public String toString() {
        ...
        sb.append(IntangibleAssets__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IntangibleAssets__1) == false) {
            return false;
        }
        IntangibleAssets__1 rhs = ((IntangibleAssets__1) other);
