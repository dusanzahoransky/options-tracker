...
public class AnnualNetPPE {
    ...
    public String toString() {
        ...
        sb.append(AnnualNetPPE.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualNetPPE) == false) {
            return false;
        }
        AnnualNetPPE rhs = ((AnnualNetPPE) other);
