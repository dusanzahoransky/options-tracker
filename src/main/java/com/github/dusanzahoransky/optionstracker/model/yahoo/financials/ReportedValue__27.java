...
public class ReportedValue__27 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__27.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__27) == false) {
            return false;
        }
        ReportedValue__27 rhs = ((ReportedValue__27) other);
