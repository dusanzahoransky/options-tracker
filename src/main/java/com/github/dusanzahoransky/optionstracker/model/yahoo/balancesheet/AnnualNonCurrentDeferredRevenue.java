...
public class AnnualNonCurrentDeferredRevenue {
    ...
    public String toString() {
        ...
        sb.append(AnnualNonCurrentDeferredRevenue.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualNonCurrentDeferredRevenue) == false) {
            return false;
        }
        AnnualNonCurrentDeferredRevenue rhs = ((AnnualNonCurrentDeferredRevenue) other);
