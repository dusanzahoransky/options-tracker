...
public class RegularMarketPreviousClose__7 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose__7 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose__7) == false) {
            return false;
        }
        RegularMarketPreviousClose__7 rhs = ((RegularMarketPreviousClose__7) other);
