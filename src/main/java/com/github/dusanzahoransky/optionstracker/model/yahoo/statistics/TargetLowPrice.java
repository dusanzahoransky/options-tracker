...
public class TargetLowPrice {
    ...
    public String toString() {
        ...
        sb.append(TargetLowPrice.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TargetLowPrice) == false) {
            return false;
        }
        TargetLowPrice rhs = ((TargetLowPrice) other);
