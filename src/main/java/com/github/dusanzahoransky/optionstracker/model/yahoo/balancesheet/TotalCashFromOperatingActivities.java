...
public class TotalCashFromOperatingActivities {
    ...
    public String toString() {
        ...
        sb.append(TotalCashFromOperatingActivities.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalCashFromOperatingActivities) == false) {
            return false;
        }
        TotalCashFromOperatingActivities rhs = ((TotalCashFromOperatingActivities) other);
