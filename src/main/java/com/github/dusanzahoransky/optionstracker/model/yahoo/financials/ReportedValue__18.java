...
public class ReportedValue__18 {
    ...
    public String toString() {
        ...
        sb.append(ReportedValue__18.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportedValue__18) == false) {
            return false;
        }
        ReportedValue__18 rhs = ((ReportedValue__18) other);
