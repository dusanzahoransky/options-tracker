...
public class CommunicationServices {
    ...
    public String toString() {
        ...
        sb.append(CommunicationServices.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CommunicationServices) == false) {
            return false;
        }
        CommunicationServices rhs = ((CommunicationServices) other);
