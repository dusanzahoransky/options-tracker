...
public class AnnualNetIncomeCommonStockholder {
    ...
    private ReportedValue__14 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__14 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__14 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualNetIncomeCommonStockholder.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualNetIncomeCommonStockholder) == false) {
            return false;
        }
        AnnualNetIncomeCommonStockholder rhs = ((AnnualNetIncomeCommonStockholder) other);
