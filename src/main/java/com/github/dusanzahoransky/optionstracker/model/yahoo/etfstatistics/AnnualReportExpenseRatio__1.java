...
public class AnnualReportExpenseRatio__1 {
    ...
    public String toString() {
        ...
        sb.append(AnnualReportExpenseRatio__1 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualReportExpenseRatio__1) == false) {
            return false;
        }
        AnnualReportExpenseRatio__1 rhs = ((AnnualReportExpenseRatio__1) other);
