...
public class AnnualBasicEP {
    ...
    private ReportedValue__29 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__29 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__29 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(AnnualBasicEP.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualBasicEP) == false) {
            return false;
        }
        AnnualBasicEP rhs = ((AnnualBasicEP) other);
