...
public class RepurchaseOfStock__1 {
    ...
    public String toString() {
        ...
        sb.append(RepurchaseOfStock__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RepurchaseOfStock__1) == false) {
            return false;
        }
        RepurchaseOfStock__1 rhs = ((RepurchaseOfStock__1) other);
