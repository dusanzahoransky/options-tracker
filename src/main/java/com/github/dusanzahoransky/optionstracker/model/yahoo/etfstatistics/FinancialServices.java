...
public class FinancialServices {
    ...
    public String toString() {
        ...
        sb.append(FinancialServices.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FinancialServices) == false) {
            return false;
        }
        FinancialServices rhs = ((FinancialServices) other);
