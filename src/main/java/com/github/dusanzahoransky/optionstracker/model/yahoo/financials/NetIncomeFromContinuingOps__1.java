...
public class NetIncomeFromContinuingOps__1 {
    ...
    public String toString() {
        ...
        sb.append(NetIncomeFromContinuingOps__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncomeFromContinuingOps__1) == false) {
            return false;
        }
        NetIncomeFromContinuingOps__1 rhs = ((NetIncomeFromContinuingOps__1) other);
