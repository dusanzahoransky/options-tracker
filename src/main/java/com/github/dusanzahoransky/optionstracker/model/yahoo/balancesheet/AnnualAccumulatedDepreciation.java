...
public class AnnualAccumulatedDepreciation {
    ...
    public String toString() {
        ...
        sb.append(AnnualAccumulatedDepreciation.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnnualAccumulatedDepreciation) == false) {
            return false;
        }
        AnnualAccumulatedDepreciation rhs = ((AnnualAccumulatedDepreciation) other);
