...
public class RegularMarketPreviousClose__3 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketPreviousClose__3 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketPreviousClose__3) == false) {
            return false;
        }
        RegularMarketPreviousClose__3 rhs = ((RegularMarketPreviousClose__3) other);
