...
public class TrailingNetIncomeCommonStockholder {
    ...
    private ReportedValue__8 reportedValue;
    @JsonIgnore
    ...
    @JsonProperty("reportedValue")
    public ReportedValue__8 getReportedValue() {
        return reportedValue;
    }

    @JsonProperty("reportedValue")
    public void setReportedValue(ReportedValue__8 reportedValue) {
    ...
    public String toString() {
        ...
        sb.append(TrailingNetIncomeCommonStockholder.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dataId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrailingNetIncomeCommonStockholder) == false) {
            return false;
        }
        TrailingNetIncomeCommonStockholder rhs = ((TrailingNetIncomeCommonStockholder) other);
