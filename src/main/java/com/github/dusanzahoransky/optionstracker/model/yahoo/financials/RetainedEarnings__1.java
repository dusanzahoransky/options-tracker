...
public class RetainedEarnings__1 {
    ...
    public String toString() {
        ...
        sb.append(RetainedEarnings__1.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetainedEarnings__1) == false) {
            return false;
        }
        RetainedEarnings__1 rhs = ((RetainedEarnings__1) other);
