...
public class ShortLongTermDebt {
    ...
    public String toString() {
        ...
        sb.append(ShortLongTermDebt.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ShortLongTermDebt) == false) {
            return false;
        }
        ShortLongTermDebt rhs = ((ShortLongTermDebt) other);
