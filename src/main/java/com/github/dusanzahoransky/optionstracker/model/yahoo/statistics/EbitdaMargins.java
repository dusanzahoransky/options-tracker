...
public class EbitdaMargins {
    ...
    public String toString() {
        ...
        sb.append(EbitdaMargins.class.getName()).append('@').append(Double.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EbitdaMargins) == false) {
            return false;
        }
        EbitdaMargins rhs = ((EbitdaMargins) other);
