...
public class SellingGeneralAdministrative {
    ...
    public String toString() {
        ...
        sb.append(SellingGeneralAdministrative.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SellingGeneralAdministrative) == false) {
            return false;
        }
        SellingGeneralAdministrative rhs = ((SellingGeneralAdministrative) other);
