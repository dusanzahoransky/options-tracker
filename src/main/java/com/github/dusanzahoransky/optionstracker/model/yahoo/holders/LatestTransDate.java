...
public class LatestTransDate {
    ...
    public String toString() {
        ...
        sb.append(LatestTransDate.class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LatestTransDate) == false) {
            return false;
        }
        LatestTransDate rhs = ((LatestTransDate) other);
