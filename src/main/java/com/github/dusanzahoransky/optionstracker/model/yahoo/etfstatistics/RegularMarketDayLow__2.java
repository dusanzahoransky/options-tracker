...
public class RegularMarketDayLow__2 {
    ...
    public String toString() {
        ...
        sb.append(RegularMarketDayLow__2 .class.getName()).append('@').append(Long.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegularMarketDayLow__2) == false) {
            return false;
        }
        RegularMarketDayLow__2 rhs = ((RegularMarketDayLow__2) other);
